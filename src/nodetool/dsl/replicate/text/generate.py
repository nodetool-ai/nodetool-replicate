...
class Claude_3_7_Sonnet(GraphNode):
    ...
    max_image_resolution: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.5,
    ...
    def get_node_type(cls):
        return "replicate.text.generate.Claude_3_7_Sonnet"
...
class Deepseek_R1(GraphNode):
    ...
    presence_penalty: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0, description="Presence penalty"
    )
    frequency_penalty: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0, description="Frequency penalty"
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.Deepseek_R1"
...
class Llama3_1_405B_Instruct(GraphNode):
    ...
    min_tokens: int | GraphNode | tuple[GraphNode, str] = Field(
        default=0,
    ...
    stop_sequences: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.Llama3_1_405B_Instruct"
...
class Llama3_70B(GraphNode):
    ...
    prompt_template: str | GraphNode | tuple[GraphNode, str] = Field(
        default="{prompt}",
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.Llama3_70B"
...
class Llama3_70B_Instruct(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.Llama3_70B_Instruct"
...
class Llama3_8B(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.Llama3_8B"
...
class Llama3_8B_Instruct(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.Llama3_8B_Instruct"
...
class LlamaGuard_3_11B_Vision(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.LlamaGuard_3_11B_Vision"
...
class LlamaGuard_3_8B(GraphNode):
    ...
    assistant: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="Assistant response to classify"
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.LlamaGuard_3_8B"


class Snowflake_Arctic_Instruct(GraphNode):
    """An efficient, intelligent, and truly open-source language model"""

    name: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description=None
    )
    name_file: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description=None
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.text.generate.Snowflake_Arctic_Instruct"
