...
class Gemini_3_Pro(SingleOutputGraphNode[str], GraphNode[str]):
    """
    ...
    thinking_level: (
        nodetool.nodes.replicate.text.generate.Gemini_3_Pro.Thinking_level
        | OutputHandle[
            nodetool.nodes.replicate.text.generate.Gemini_3_Pro.Thinking_level
        ]
        | None
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.text.generate.Gemini_3_Pro
