...
class Deepseek_V3_1(SingleOutputGraphNode[str], GraphNode[str]):
    ...
    Thinking: typing.ClassVar[type] = (
        nodetool.nodes.replicate.text.generate.Deepseek_V3_1.Thinking
    )
    ...
    prompt: str | OutputHandle[str] = connect_field(
        default="Why are you better than Deepseek v3?", description="Prompt"
    )
    thinking: nodetool.nodes.replicate.text.generate.Deepseek_V3_1.Thinking = Field(
        default=nodetool.nodes.replicate.text.generate.Deepseek_V3_1.Thinking("None"),
...
class GPT_5_2(SingleOutputGraphNode[str], GraphNode[str]):
    """
    The best model for coding and agentic tasks across industries
    """

    Verbosity: typing.ClassVar[type] = (
        nodetool.nodes.replicate.text.generate.GPT_5_2.Verbosity
    )
    Reasoning_effort: typing.ClassVar[type] = (
        nodetool.nodes.replicate.text.generate.GPT_5_2.Reasoning_effort
    )
    ...
    verbosity: nodetool.nodes.replicate.text.generate.GPT_5_2.Verbosity = Field(
        default=nodetool.nodes.replicate.text.generate.GPT_5_2.Verbosity("medium"),
        description="Constrains the verbosity of the model's response. Lower values will result in more concise responses, while higher values will result in more verbose responses. Currently supported values are low, medium, and high. GPT-5 supports this parameter to help control whether answers are short and to the point or long and comprehensive.",
    )
    image_input: list | OutputHandle[list] = connect_field(
        default=[], description="List of images to send to the model"
    ...
    reasoning_effort: (
        ...
        default=nodetool.nodes.replicate.text.generate.GPT_5_2.Reasoning_effort("low"),
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.text.generate.GPT_5_2
