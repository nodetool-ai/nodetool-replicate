...
class DD_Color(GraphNode):
    ...
    def get_node_type(cls):
        return "replicate.image.process.DD_Color"
...
class Magic_Style_Transfer(GraphNode):
    ...
    ip_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="Input image for img2img or inpaint mode",
    )
    ip_scale: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    resizing_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1,
    ...
    condition_canny_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.15,
        description="The bigger this number is, the more ControlNet interferes",
    )
    condition_depth_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.35,
        description="The bigger this number is, the more ControlNet interferes",
    )
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.process.Magic_Style_Transfer"
...
class ModNet(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.process.ModNet"


class ObjectRemover(GraphNode):
    """None"""

    org_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.process.ObjectRemover"
...
class RemoveBackground(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.process.RemoveBackground"
