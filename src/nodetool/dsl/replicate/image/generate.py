...
class GPT_Image_1(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    """
    ...
    Quality: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.GPT_Image_1.Quality
    )
    Background: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.GPT_Image_1.Background
    )
    Moderation: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.GPT_Image_1.Moderation
    )
    Aspect_ratio: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.GPT_Image_1.Aspect_ratio
    )
    Output_format: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.GPT_Image_1.Output_format
    )
    Input_fidelity: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.GPT_Image_1.Input_fidelity
    )

    prompt: str | OutputHandle[str] | None = connect_field(
        default=None, description="A text description of the desired image"
    )
    quality: nodetool.nodes.replicate.image.generate.GPT_Image_1.Quality = Field(
        default=nodetool.nodes.replicate.image.generate.GPT_Image_1.Quality("auto"),
    ...
    background: nodetool.nodes.replicate.image.generate.GPT_Image_1.Background = Field(
        default=nodetool.nodes.replicate.image.generate.GPT_Image_1.Background("auto"),
        description="Set whether the background is transparent or opaque or choose automatically",
    )
    moderation: nodetool.nodes.replicate.image.generate.GPT_Image_1.Moderation = Field(
        default=nodetool.nodes.replicate.image.generate.GPT_Image_1.Moderation("auto"),
        description="Content moderation level",
    )
    aspect_ratio: nodetool.nodes.replicate.image.generate.GPT_Image_1.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.image.generate.GPT_Image_1.Aspect_ratio(
                "1:1"
            ),
    ...
    output_format: nodetool.nodes.replicate.image.generate.GPT_Image_1.Output_format = (
        Field(
            default=nodetool.nodes.replicate.image.generate.GPT_Image_1.Output_format(
                "webp"
            ),
    ...
    input_fidelity: (
        ...
        default=nodetool.nodes.replicate.image.generate.GPT_Image_1.Input_fidelity(
            "low"
        ),
    ...
    openai_api_key: str | OutputHandle[str] | None = connect_field(
        default=None, description="Your OpenAI API key"
    )
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.image.generate.GPT_Image_1
