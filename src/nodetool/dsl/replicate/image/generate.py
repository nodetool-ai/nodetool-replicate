...
class AdInpaint(GraphNode):
    ...
    pixel: nodetool.nodes.replicate.image.generate.AdInpaint.Pixel = Field(
        default=nodetool.nodes.replicate.image.generate.AdInpaint.Pixel._512___512,
    ...
    image_num: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of image to generate"
    )
    image_path: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="input image",
    )
    manual_seed: int | GraphNode | tuple[GraphNode, str] = Field(
        default=-1, description="Manual Seed"
    )
    product_size: nodetool.nodes.replicate.image.generate.AdInpaint.Product_size = (
        Field(
            default=nodetool.nodes.replicate.image.generate.AdInpaint.Product_size.ORIGINAL,
    ...
    def get_node_type(cls):
        return "replicate.image.generate.AdInpaint"
...
class ConsistentCharacter(GraphNode):
    ...
    subject: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.ConsistentCharacter.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    randomise_poses: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True, description="Randomise the poses used."
    )
    number_of_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
        default=3, description="The number of images to generate."
    )
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False, description="Disable safety checker for generated images."
    )
    number_of_images_per_pose: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="The number of images to generate for each pose."
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.ConsistentCharacter"
...
class Flux_1_1_Pro_Ultra(GraphNode):
    ...
    raw: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image",
    )
    image_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Output_format.JPG,
        description="Format of the output images.",
    )
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_1_1_Pro_Ultra"
...
class Flux_360(GraphNode):
    ...
    width: int | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    height: int | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
    ...
    extra_lora: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_360.Megapixels = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_360.Megapixels._1,
        description="Approximate number of megapixels for generated image",
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_360.Aspect_ratio = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_360.Aspect_ratio._1_1,
    ...
    output_format: nodetool.nodes.replicate.image.generate.Flux_360.Output_format = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_360.Output_format.WEBP,
            description="Format of the output images",
        )
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.8,
        description="Prompt strength when using img2img. 1.0 corresponds to full destruction of information in image",
    )
    extra_lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1,
    ...
    replicate_weights: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
        description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'",
    )
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_360"
...
class Flux_Black_Light(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Black_Light.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Megapixels._1,
            description="Approximate number of megapixels for generated image",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.Flux_Black_Light.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Output_format.WEBP,
        description="Format of the output images",
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=3,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Black_Light"
...
class Flux_Canny_Dev(GraphNode):
    ...
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Megapixels._1,
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Canny_Dev"
...
class Flux_Canny_Pro(GraphNode):
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Canny_Pro.Output_format.JPG,
        description="Format of the output images.",
    )
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(
        default=2,
    ...
    prompt_upsampling: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Canny_Pro"
...
class Flux_Cinestill(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Cinestill.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Megapixels._1,
            description="Approximate number of megapixels for generated image",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.Flux_Cinestill.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Output_format.WEBP,
        description="Format of the output images",
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=3,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Cinestill"
...
class Flux_Depth_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Megapixels._1,
            description="Approximate number of megapixels for generated image. Use match_input to match the size of the input (with an upper limit of 1440x1440 pixels)",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Depth_Dev"
...
class Flux_Depth_Pro(GraphNode):
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Depth_Pro.Output_format.JPG,
        description="Format of the output images.",
    )
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(
        default=2,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Depth_Pro"
...
class Flux_Dev(GraphNode):
    ...
    image: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Dev.Megapixels = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Dev.Megapixels._1,
        description="Approximate number of megapixels for generated image",
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of outputs to generate"
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Dev.Aspect_ratio = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Dev.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image",
    )
    output_format: nodetool.nodes.replicate.image.generate.Flux_Dev.Output_format = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Dev.Output_format.WEBP,
            description="Format of the output images",
        )
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Dev"
...
class Flux_Dev_Lora(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Megapixels._1,
            description="Approximate number of megapixels for generated image",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Aspect_ratio._1_1,
            description="Aspect ratio for the generated image",
        )
    )
    lora_weights: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
        description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'",
    )
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Dev_Lora"
...
class Flux_Fill_Dev(GraphNode):
    ...
    mask: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Fill_Dev.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Fill_Dev.Megapixels._1,
            description="Approximate number of megapixels for generated image. Use match_input to match the size of the input (with an upper limit of 1440x1440 pixels)",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Fill_Dev.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Fill_Dev"
...
class Flux_Fill_Pro(GraphNode):
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Fill_Pro.Output_format.JPG,
        description="Format of the output images.",
    )
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(
        default=2,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Fill_Pro"
...
class Flux_Mona_Lisa(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Megapixels._1,
            description="Approximate number of megapixels for generated image",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Output_format.WEBP,
        description="Format of the output images",
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=3,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Mona_Lisa"
...
class Flux_Pro(GraphNode):
    ...
    steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=25, description="Number of diffusion steps"
    )
    width: int | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    interval: float | GraphNode | tuple[GraphNode, str] = Field(
        default=2,
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Pro.Aspect_ratio = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Pro.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image",
    )
    image_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    output_format: nodetool.nodes.replicate.image.generate.Flux_Pro.Output_format = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Pro.Output_format.WEBP,
            description="Format of the output images.",
        )
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Pro"
...
class Flux_Redux_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Megapixels._1,
            description="Approximate number of megapixels for generated image",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    redux_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Redux_Dev"
...
class Flux_Redux_Schnell(GraphNode):
    ...
    megapixels: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Megapixels._1,
        description="Approximate number of megapixels for generated image",
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of outputs to generate"
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Redux_Schnell"
...
class Flux_Schnell(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Schnell.Megapixels = Field(
        default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Megapixels._1,
        description="Approximate number of megapixels for generated image",
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of outputs to generate"
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Schnell.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Aspect_ratio._1_1,
            description="Aspect ratio for the generated image",
        )
    )
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Schnell"
...
class Flux_Schnell_Lora(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Megapixels = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Megapixels._1,
            description="Approximate number of megapixels for generated image",
        )
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Aspect_ratio._1_1,
        description="Aspect ratio for the generated image",
    )
    lora_weights: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Flux_Schnell_Lora"
...
class Hyper_Flux_8Step(GraphNode):
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Aspect_ratio._1_1,
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Output_format.WEBP,
        description="Format of the output images",
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Hyper_Flux_8Step"
...
class Ideogram_V2(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Ideogram_V2.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Ideogram_V2.Aspect_ratio._1_1,
    ...
    magic_prompt_option: (
        ...
        default=nodetool.nodes.replicate.image.generate.Ideogram_V2.Magic_prompt_option.AUTO,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Ideogram_V2"
...
class Ideogram_V2A(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Ideogram_V2A.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Ideogram_V2A.Aspect_ratio._1_1,
            description="Aspect ratio. Ignored if a resolution or inpainting image is given.",
        )
    )
    magic_prompt_option: (
        ...
        default=nodetool.nodes.replicate.image.generate.Ideogram_V2A.Magic_prompt_option.AUTO,
        description="Magic Prompt will interpret your prompt and optimize it to maximize variety and quality of the images generated. You can also use it to write prompts in different languages.",
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Ideogram_V2A"
...
class Ideogram_V2_Turbo(GraphNode):
    ...
    resolution: nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Resolution = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Resolution.NONE,
            description="Resolution. Overrides aspect ratio. Ignored if an inpainting image is given.",
        )
    )
    style_type: nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Style_type = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Style_type.NONE,
            description="The styles help define the specific aesthetic of the image you want to generate.",
        )
    )
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Aspect_ratio._1_1,
        description="Aspect ratio. Ignored if a resolution or inpainting image is given.",
    )
    negative_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    magic_prompt_option: (
        ...
        default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Magic_prompt_option.AUTO,
        description="Magic Prompt will interpret your prompt and optimize it to maximize variety and quality of the images generated. You can also use it to write prompts in different languages.",
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Ideogram_V2_Turbo"
...
class Illusions(GraphNode):
    ...
    controlnet_end: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    sizing_strategy: (
        ...
        default=nodetool.nodes.replicate.image.generate.Illusions.Sizing_strategy.WIDTH_HEIGHT,
        description="Decide how to resize images – use width/height, resize based on input image or control image",
    )
    controlnet_start: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Illusions"
...
class Imagen_3(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Imagen_3.Aspect_ratio = Field(
        default=nodetool.nodes.replicate.image.generate.Imagen_3.Aspect_ratio._1_1,
    ...
    safety_filter_level: (
        ...
        default=nodetool.nodes.replicate.image.generate.Imagen_3.Safety_filter_level.BLOCK_MEDIUM_AND_ABOVE,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Imagen_3"
...
class Kandinsky(GraphNode):
    ...
    width: nodetool.nodes.replicate.image.generate.Kandinsky.Width = Field(
        default=nodetool.nodes.replicate.image.generate.Kandinsky.Width._512,
    ...
    height: nodetool.nodes.replicate.image.generate.Kandinsky.Height = Field(
        default=nodetool.nodes.replicate.image.generate.Kandinsky.Height._512,
    ...
    output_format: nodetool.nodes.replicate.image.generate.Kandinsky.Output_format = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Kandinsky.Output_format.WEBP,
    ...
    num_inference_steps_prior: int | GraphNode | tuple[GraphNode, str] = Field(
        default=25, description="Number of denoising steps for priors"
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Kandinsky"
...
class Kandinsky_2_2(GraphNode):
    ...
    width: nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Width = Field(
        default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Width._512,
        description="Width of output image. Lower the setting if hits memory limits.",
    )
    height: nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Height = Field(
        default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Height._512,
        description="Height of output image. Lower the setting if hits memory limits.",
    )
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(
        default="A moss covered astronaut with a black background",
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Output_format.WEBP,
        description="Output image format",
    )
    negative_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="Specify things to not see in the output"
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Kandinsky_2_2"
...
class Photon_Flash(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Photon_Flash.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Photon_Flash.Aspect_ratio._16_9,
            description="Aspect ratio of the generated image",
        )
    )
    image_reference_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="URL of a reference image to guide generation",
    )
    style_reference_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="URL of a style reference image",
    )
    image_reference_weight: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.85,
    ...
    style_reference_weight: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.85, description="Weight of the style reference image"
    )
    character_reference_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Photon_Flash"
...
class PlaygroundV2(GraphNode):
    ...
    scheduler: nodetool.nodes.replicate.image.generate.PlaygroundV2.Scheduler = Field(
        default=nodetool.nodes.replicate.image.generate.PlaygroundV2.Scheduler.DPMSOLVER,
    ...
    apply_watermark: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.PlaygroundV2"
...
class Proteus_V_02(GraphNode):
    ...
    scheduler: nodetool.nodes.replicate.image.generate.Proteus_V_02.Scheduler = Field(
        default=nodetool.nodes.replicate.image.generate.Proteus_V_02.Scheduler.KARRASDPM,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Proteus_V_02"
...
class Proteus_V_03(GraphNode):
    ...
    scheduler: nodetool.nodes.replicate.image.generate.Proteus_V_03.Scheduler = Field(
        default=nodetool.nodes.replicate.image.generate.Proteus_V_03.Scheduler.DPM__2MSDE,
        description="scheduler",
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of images to output."
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Proteus_V_03"
...
class PulidBase(GraphNode):
    ...
    face_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    face_style: nodetool.nodes.replicate.image.generate.PulidBase.Face_style = Field(
        default=nodetool.nodes.replicate.image.generate.PulidBase.Face_style.HIGH_FIDELITY,
        description="Style of the face",
    )
    output_format: nodetool.nodes.replicate.image.generate.PulidBase.Output_format = (
        Field(
            default=nodetool.nodes.replicate.image.generate.PulidBase.Output_format.WEBP,
            description="Format of the output images",
        )
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    checkpoint_model: (
        ...
        default=nodetool.nodes.replicate.image.generate.PulidBase.Checkpoint_model.GENERAL___DREAMSHAPERXL_ALPHA2XL10,
        description="Model to use for the generation",
    )
    number_of_images: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of images to generate"
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.PulidBase"
...
class Recraft_20B(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_20B.Size = Field(
        default=nodetool.nodes.replicate.image.generate.Recraft_20B.Size._1024X1024,
        description="Width and height of the generated image",
    )
    style: nodetool.nodes.replicate.image.generate.Recraft_20B.Style = Field(
        default=nodetool.nodes.replicate.image.generate.Recraft_20B.Style.REALISTIC_IMAGE,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Recraft_20B"
...
class Recraft_20B_SVG(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Size = Field(
        default=nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Size._1024X1024,
        description="Width and height of the generated image",
    )
    style: nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Style = Field(
        default=nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Style.VECTOR_ILLUSTRATION,
        description="Style of the generated image.",
    )
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="Text prompt for image generation"
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Recraft_20B_SVG"
...
class Recraft_V3(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_V3.Size = Field(
        default=nodetool.nodes.replicate.image.generate.Recraft_V3.Size._1024X1024,
        description="Width and height of the generated image",
    )
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Recraft_V3"
...
class Recraft_V3_SVG(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Size = Field(
        default=nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Size._1024X1024,
        description="Width and height of the generated image",
    )
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.Recraft_V3_SVG"
...
class SDXL_Ad_Inpaint(GraphNode):
    ...
    img_size: nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Img_size = Field(
        default=nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Img_size._1024__1024,
        description="Possible SDXL image sizes",
    )
    apply_img: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True,
    ...
    product_fill: (
        ...
        default=nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Product_fill.ORIGINAL,
        description="What percentage of the image width to fill with product",
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=7.5, description="Guidance Scale"
    )
    condition_scale: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    num_refine_steps: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.SDXL_Ad_Inpaint"
...
class SDXL_Controlnet(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.SDXL_Controlnet"
...
class SDXL_Emoji(GraphNode):
    ...
    refine_steps: int | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    high_noise_frac: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.8,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.SDXL_Emoji"
...
class SDXL_Pixar(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.SDXL_Pixar"
...
class StableDiffusion(GraphNode):
    ...
    width: nodetool.nodes.replicate.image.generate.StableDiffusion.Width = Field(
        default=nodetool.nodes.replicate.image.generate.StableDiffusion.Width._768,
    ...
    height: nodetool.nodes.replicate.image.generate.StableDiffusion.Height = Field(
        default=nodetool.nodes.replicate.image.generate.StableDiffusion.Height._768,
    ...
    scheduler: nodetool.nodes.replicate.image.generate.StableDiffusion.Scheduler = (
        Field(
            default=nodetool.nodes.replicate.image.generate.StableDiffusion.Scheduler.DPMSOLVERMULTISTEP,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StableDiffusion"
...
class StableDiffusion3_5_Large(GraphNode):
    ...
    steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=35, description="Number of steps to run the sampler for."
    )
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Aspect_ratio._1_1,
        description="The aspect ratio of your output image. This value is ignored if you are using an input image.",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=90,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StableDiffusion3_5_Large"
...
class StableDiffusion3_5_Large_Turbo(GraphNode):
    ...
    steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=4, description="Number of steps to run the sampler for."
    )
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(
        default="", description="Text prompt for image generation"
    )
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large_Turbo.Aspect_ratio._1_1,
        description="The aspect ratio of your output image. This value is ignored if you are using an input image.",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large_Turbo.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large_Turbo.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=90,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StableDiffusion3_5_Large_Turbo"
...
class StableDiffusion3_5_Medium(GraphNode):
    ...
    steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=40, description="Number of steps to run the sampler for."
    )
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(
        default="", description="Text prompt for image generation"
    )
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Aspect_ratio._1_1,
        description="The aspect ratio of your output image. This value is ignored if you are using an input image.",
    )
    output_format: (
        nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Output_format
    ) = Field(
        default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=90,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StableDiffusion3_5_Medium"
...
class StableDiffusionInpainting(GraphNode):
    ...
    width: nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Width = (
        Field(
            default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Width._512,
            description="Width of generated image in pixels. Needs to be a multiple of 64",
        )
    )
    height: nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Height = (
        Field(
            default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Height._512,
            description="Height of generated image in pixels. Needs to be a multiple of 64",
        )
    )
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(
    ...
    scheduler: (
        ...
        default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Scheduler.DPMSOLVERMULTISTEP,
        description="Choose a scheduler.",
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of images to generate."
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StableDiffusionInpainting"
...
class StableDiffusionXL(GraphNode):
    ...
    refine: nodetool.nodes.replicate.image.generate.StableDiffusionXL.Refine = Field(
        default=nodetool.nodes.replicate.image.generate.StableDiffusionXL.Refine.NO_REFINER,
        description="Which refine style to use",
    )
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StableDiffusionXL"
...
class StableDiffusionXLLightning(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StableDiffusionXLLightning"
...
class StickerMaker(GraphNode):
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.StickerMaker.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=90,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StickerMaker"
...
class StyleTransfer(GraphNode):
    ...
    style_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.StyleTransfer.Output_format.WEBP,
        description="Format of the output images",
    )
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(
        default=80,
    ...
    structure_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    structure_depth_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Strength of the depth controlnet"
    )
    structure_denoising_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.65,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.generate.StyleTransfer"
