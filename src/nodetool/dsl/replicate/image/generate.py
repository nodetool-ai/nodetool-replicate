...
class Flux_2_Klein_4B_Base(
    ...
    Aspect_ratio: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Flux_2_Klein_4B_Base.Aspect_ratio
    )
    Output_format: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Flux_2_Klein_4B_Base.Output_format
    )
    Output_megapixels: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Flux_2_Klein_4B_Base.Output_megapixels
    )
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_2_Klein_4B_Base.Aspect_ratio(
            "1:1"
        ),
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_2_Klein_4B_Base.Output_format(
            "jpg"
        ),
        description="Format of the output images",
    )
    ...
    output_megapixels: (
        ...
        default=nodetool.nodes.replicate.image.generate.Flux_2_Klein_4B_Base.Output_megapixels(
            "1"
        ),
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.image.generate.Flux_2_Klein_4B_Base
