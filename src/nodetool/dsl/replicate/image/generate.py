...
class AdInpaint(GraphNode):
    ...
    pixel: nodetool.nodes.replicate.image.generate.AdInpaint.Pixel = Field(default=nodetool.nodes.replicate.image.generate.AdInpaint.Pixel._512___512, description='image total pixel')
    ...
    image_path: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='input image')
    manual_seed: int | GraphNode | tuple[GraphNode, str] = Field(default=-1, description='Manual Seed')
    product_size: nodetool.nodes.replicate.image.generate.AdInpaint.Product_size = Field(default=nodetool.nodes.replicate.image.generate.AdInpaint.Product_size.ORIGINAL, description='Max product size')
...
class ConsistentCharacter(GraphNode):
    ...
    subject: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='An image of a person. Best images are square close ups of a face, but they do not have to be.')
    output_format: nodetool.nodes.replicate.image.generate.ConsistentCharacter.Output_format = Field(default=nodetool.nodes.replicate.image.generate.ConsistentCharacter.Output_format.WEBP, description='Format of the output images')
...
class Flux_1_1_Pro_Ultra(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    ...
    output_format: nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_1_1_Pro_Ultra.Output_format.JPG, description='Format of the output images.')
...
class Flux_360(GraphNode):
    ...
    mask: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Image mask for image inpainting mode. If provided, aspect_ratio, width, and height inputs are ignored.')
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image for image to image or inpainting mode. If provided, aspect_ratio, width, and height inputs are ignored.')
    model: nodetool.nodes.replicate.image.generate.Flux_360.Model = Field(default=nodetool.nodes.replicate.image.generate.Flux_360.Model.DEV, description='Which model to run inference with. The dev model performs best with around 28 inference steps but the schnell model only needs 4 steps.')
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_360.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_360.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_360.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_360.Aspect_ratio._1_1, description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
    output_format: nodetool.nodes.replicate.image.generate.Flux_360.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_360.Output_format.WEBP, description='Format of the output images')
...
class Flux_Black_Light(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image for image to image or inpainting mode. If provided, aspect_ratio, width, and height inputs are ignored.')
    model: nodetool.nodes.replicate.image.generate.Flux_Black_Light.Model = Field(default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Model.DEV, description='Which model to run inference with. The dev model performs best with around 28 inference steps but the schnell model only needs 4 steps.')
    width: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Width of generated image. Only works if `aspect_ratio` is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation')
    height: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Height of generated image. Only works if `aspect_ratio` is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for generated image. If you include the `trigger_word` used in the training process you are more likely to activate the trained object, style, or concept in the resulting image.')
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    extra_lora: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Black_Light.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Black_Light.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Aspect_ratio._1_1, description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Black_Light.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Black_Light.Output_format.WEBP, description='Format of the output images')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Guidance scale for the diffusion process. Lower values can give more realistic images. Good values to try are 2, 2.5, 3 and 3.5')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.8, description='Prompt strength when using img2img. 1.0 corresponds to full destruction of information in image')
    extra_lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the extra LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
...
class Flux_Canny_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Megapixels._1, description='Approximate number of megapixels for generated image. Use match_input to match the size of the input (with an upper limit of 1440x1440 pixels)')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Image used to control the generation. The canny edge detection will be automatically generated.')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Canny_Dev.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
...
class Flux_Canny_Pro(GraphNode):
    ...
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Image to use as control input. Must be jpeg, png, gif, or webp.')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Canny_Pro.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Canny_Pro.Output_format.JPG, description='Format of the output images.')
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(default=2, description='Safety tolerance, 1 is most strict and 6 is most permissive')
...
class Flux_Cinestill(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image for image to image or inpainting mode. If provided, aspect_ratio, width, and height inputs are ignored.')
    model: nodetool.nodes.replicate.image.generate.Flux_Cinestill.Model = Field(default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Model.DEV, description='Which model to run inference with. The dev model performs best with around 28 inference steps but the schnell model only needs 4 steps.')
    width: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Width of generated image. Only works if `aspect_ratio` is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation')
    height: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Height of generated image. Only works if `aspect_ratio` is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for generated image. If you include the `trigger_word` used in the training process you are more likely to activate the trained object, style, or concept in the resulting image.')
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    extra_lora: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Cinestill.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Cinestill.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Aspect_ratio._1_1, description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Cinestill.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Cinestill.Output_format.WEBP, description='Format of the output images')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Guidance scale for the diffusion process. Lower values can give more realistic images. Good values to try are 2, 2.5, 3 and 3.5')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.8, description='Prompt strength when using img2img. 1.0 corresponds to full destruction of information in image')
    extra_lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the extra LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
...
class Flux_Depth_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Megapixels._1, description='Approximate number of megapixels for generated image. Use match_input to match the size of the input (with an upper limit of 1440x1440 pixels)')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Image used to control the generation. The depth map will be automatically generated.')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Depth_Dev.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=28, description='Number of denoising steps. Recommended range is 28-50, and lower number of steps produce lower quality outputs, faster.')
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Disable safety checker for generated images.')
...
class Flux_Depth_Pro(GraphNode):
    ...
    steps: int | GraphNode | tuple[GraphNode, str] = Field(default=50, description='Number of diffusion steps. Higher values yield finer details but increase processing time.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(default=15, description='Controls the balance between adherence to the text as well as image prompt and image quality/diversity. Higher values make the output more closely match the prompt but may reduce overall image quality. Lower values allow for more creative freedom but might produce results less relevant to the prompt.')
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Image to use as control input. Must be jpeg, png, gif, or webp.')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Depth_Pro.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Depth_Pro.Output_format.JPG, description='Format of the output images.')
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(default=2, description='Safety tolerance, 1 is most strict and 6 is most permissive')
    prompt_upsampling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Automatically modify the prompt for more creative generation')
...
class Flux_Dev(GraphNode):
    ...
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Dev.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Dev.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.8, description='Prompt strength when using img2img. 1.0 corresponds to full destruction of information in image')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=28, description='Number of denoising steps. Recommended range is 28-50, and lower number of steps produce lower quality outputs, faster.')
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Disable safety checker for generated images.')
...
class Flux_Dev_Lora(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image for image to image mode. The aspect ratio of your output will match this image')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for generated image')
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=True, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Guidance for generated image')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    lora_weights: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    output_format: nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Dev_Lora.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.8, description='Prompt strength when using img2img. 1.0 corresponds to full destruction of information in image')
...
class Flux_Fill_Dev(GraphNode):
    ...
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(default=30, description='Guidance for generated image')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Fill_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Fill_Dev.Megapixels._1, description='Approximate number of megapixels for generated image. Use match_input to match the size of the input (with an upper limit of 1440x1440 pixels)')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    lora_weights: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    output_format: nodetool.nodes.replicate.image.generate.Flux_Fill_Dev.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Fill_Dev.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=28, description='Number of denoising steps. Recommended range is 28-50, and lower number of steps produce lower quality outputs, faster.')
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Disable safety checker for generated images.')
...
class Flux_Fill_Pro(GraphNode):
    ...
    Outpaint: typing.ClassVar[type] = nodetool.nodes.replicate.image.generate.Flux_Fill_Pro.Outpaint
    ...
    steps: int | GraphNode | tuple[GraphNode, str] = Field(default=50, description='Number of diffusion steps. Higher values yield finer details but increase processing time.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(default=60, description='Controls the balance between adherence to the text prompt and image quality/diversity. Higher values make the output more closely match the prompt but may reduce overall image quality. Lower values allow for more creative freedom but might produce results less relevant to the prompt.')
    outpaint: nodetool.nodes.replicate.image.generate.Flux_Fill_Pro.Outpaint = Field(default=nodetool.nodes.replicate.image.generate.Flux_Fill_Pro.Outpaint.NONE, description='A quick option for outpainting an input image. Mask will be ignored.')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Fill_Pro.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Fill_Pro.Output_format.JPG, description='Format of the output images.')
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(default=2, description='Safety tolerance, 1 is most strict and 6 is most permissive')
    prompt_upsampling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Automatically modify the prompt for more creative generation')
...
class Flux_Mona_Lisa(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image for image to image or inpainting mode. If provided, aspect_ratio, width, and height inputs are ignored.')
    model: nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Model = Field(default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Model.DEV, description='Which model to run inference with. The dev model performs best with around 28 inference steps but the schnell model only needs 4 steps.')
    width: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Width of generated image. Only works if `aspect_ratio` is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation')
    height: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Height of generated image. Only works if `aspect_ratio` is set to custom. Will be rounded to nearest multiple of 16. Incompatible with fast generation')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for generated image. If you include the `trigger_word` used in the training process you are more likely to activate the trained object, style, or concept in the resulting image.')
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    extra_lora: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Aspect_ratio._1_1, description='Aspect ratio for the generated image. If custom is selected, uses height and width below & will run in bf16 mode')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Mona_Lisa.Output_format.WEBP, description='Format of the output images')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Guidance scale for the diffusion process. Lower values can give more realistic images. Good values to try are 2, 2.5, 3 and 3.5')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.8, description='Prompt strength when using img2img. 1.0 corresponds to full destruction of information in image')
    extra_lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the extra LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
...
class Flux_Pro(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Pro.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Pro.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    image_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Image to use with Flux Redux. This is used together with the text prompt to guide the generation towards the composition of the image_prompt. Must be jpeg, png, gif, or webp.')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Pro.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Pro.Output_format.WEBP, description='Format of the output images.')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    safety_tolerance: int | GraphNode | tuple[GraphNode, str] = Field(default=2, description='Safety tolerance, 1 is most strict and 6 is most permissive')
    prompt_upsampling: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Automatically modify the prompt for more creative generation')
...
class Flux_Redux_Dev(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    guidance: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Guidance for generated image')
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    redux_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image to condition your output on. This replaces prompt for FLUX.1 Redux models')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Dev.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=28, description='Number of denoising steps. Recommended range is 28-50')
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Disable safety checker for generated images.')
...
class Flux_Redux_Schnell(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    redux_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image to condition your output on. This replaces prompt for FLUX.1 Redux models')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Redux_Schnell.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
...
class Flux_Schnell(GraphNode):
    ...
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for generated image')
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=True, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Schnell.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Schnell.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    output_format: nodetool.nodes.replicate.image.generate.Flux_Schnell.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=4, description='Number of denoising steps. 4 is recommended, and lower number of steps produce lower quality outputs, faster.')
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Disable safety checker for generated images.')
...
class Flux_Schnell_Lora(GraphNode):
    ...
    go_fast: bool | GraphNode | tuple[GraphNode, str] = Field(default=True, description='Run faster predictions with model optimized for speed (currently fp8 quantized); disable to run in original bf16')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=1, description="Determines how strongly the main LoRA should be applied. Sane results between 0 and 1 for base inference. For go_fast we apply a 1.5x multiplier to this value; we've generally seen good performance when scaling the base value by that amount. You may still need to experiment to find the best value for your particular lora.")
    megapixels: nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Megapixels = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Megapixels._1, description='Approximate number of megapixels for generated image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs to generate')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Aspect_ratio._1_1, description='Aspect ratio for the generated image')
    lora_weights: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description="Load LoRA weights. Supports Replicate models in the format <owner>/<username> or <owner>/<username>/<version>, HuggingFace URLs in the format huggingface.co/<owner>/<model-name>, CivitAI URLs in the format civitai.com/models/<id>[/<model-name>], or arbitrary .safetensors URLs from the Internet. For example, 'fofr/flux-pixar-cars'")
    output_format: nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Flux_Schnell_Lora.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality when saving the output images, from 0 to 100. 100 is best quality, 0 is lowest quality. Not relevant for .png outputs')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=4, description='Number of denoising steps. 4 is recommended, and lower number of steps produce lower quality outputs, faster.')
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Disable safety checker for generated images.')
...
class Hyper_Flux_8Step(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Aspect_ratio._1_1, description="Aspect ratio for the generated image. The size will always be 1 megapixel, i.e. 1024x1024 if aspect ratio is 1:1. To use arbitrary width and height, set aspect ratio to 'custom'.")
    output_format: nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Hyper_Flux_8Step.Output_format.WEBP, description='Format of the output images')
...
class Ideogram_V2(GraphNode):
    ...
    mask: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='A black and white image. Black pixels are inpainted, white pixels are preserved. The mask will be resized to match the image size.')
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='An image file to use for inpainting.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    resolution: nodetool.nodes.replicate.image.generate.Ideogram_V2.Resolution = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2.Resolution.NONE, description='Resolution. Overrides aspect ratio. Ignored if an inpainting image is given.')
    style_type: nodetool.nodes.replicate.image.generate.Ideogram_V2.Style_type = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2.Style_type.NONE, description='The styles help define the specific aesthetic of the image you want to generate.')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Ideogram_V2.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2.Aspect_ratio._1_1, description='Aspect ratio. Ignored if a resolution or inpainting image is given.')
    ...
    magic_prompt_option: nodetool.nodes.replicate.image.generate.Ideogram_V2.Magic_prompt_option = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2.Magic_prompt_option.AUTO, description='Magic Prompt will interpret your prompt and optimize it to maximize variety and quality of the images generated. You can also use it to write prompts in different languages.')
...
class Ideogram_V2A(GraphNode):
    """Like Ideogram v2, but faster and cheaper"""

    Resolution: typing.ClassVar[type] = nodetool.nodes.replicate.image.generate.Ideogram_V2A.Resolution
    Style_type: typing.ClassVar[type] = nodetool.nodes.replicate.image.generate.Ideogram_V2A.Style_type
    Aspect_ratio: typing.ClassVar[type] = nodetool.nodes.replicate.image.generate.Ideogram_V2A.Aspect_ratio
    Magic_prompt_option: typing.ClassVar[type] = nodetool.nodes.replicate.image.generate.Ideogram_V2A.Magic_prompt_option
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    resolution: nodetool.nodes.replicate.image.generate.Ideogram_V2A.Resolution = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2A.Resolution.NONE, description='Resolution. Overrides aspect ratio. Ignored if an inpainting image is given.')
    style_type: nodetool.nodes.replicate.image.generate.Ideogram_V2A.Style_type = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2A.Style_type.NONE, description='The styles help define the specific aesthetic of the image you want to generate.')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Ideogram_V2A.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2A.Aspect_ratio._1_1, description='Aspect ratio. Ignored if a resolution or inpainting image is given.')
    magic_prompt_option: nodetool.nodes.replicate.image.generate.Ideogram_V2A.Magic_prompt_option = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2A.Magic_prompt_option.AUTO, description='Magic Prompt will interpret your prompt and optimize it to maximize variety and quality of the images generated. You can also use it to write prompts in different languages.')

    @classmethod
    def get_node_type(cls): return "replicate.image.generate.Ideogram_V2A"
...
class Ideogram_V2_Turbo(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='An image file to use for inpainting.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    resolution: nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Resolution = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Resolution.NONE, description='Resolution. Overrides aspect ratio. Ignored if an inpainting image is given.')
    style_type: nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Style_type = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Style_type.NONE, description='The styles help define the specific aesthetic of the image you want to generate.')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Aspect_ratio._1_1, description='Aspect ratio. Ignored if a resolution or inpainting image is given.')
    negative_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Things you do not want to see in the generated image.')
    magic_prompt_option: nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Magic_prompt_option = Field(default=nodetool.nodes.replicate.image.generate.Ideogram_V2_Turbo.Magic_prompt_option.AUTO, description='Magic Prompt will interpret your prompt and optimize it to maximize variety and quality of the images generated. You can also use it to write prompts in different languages.')
...
class Illusions(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Optional img2img')
    ...
    mask_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Optional mask for inpainting')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of outputs')
    control_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Control image')
    ...
    sizing_strategy: nodetool.nodes.replicate.image.generate.Illusions.Sizing_strategy = Field(default=nodetool.nodes.replicate.image.generate.Illusions.Sizing_strategy.WIDTH_HEIGHT, description='Decide how to resize images – use width/height, resize based on input image or control image')
...
class Imagen_3(GraphNode):
    """Google's highest quality text-to-image model, capable of generating images with detail, rich lighting and beauty"""

    Aspect_ratio: typing.ClassVar[type] = nodetool.nodes.replicate.image.generate.Imagen_3.Aspect_ratio
    Safety_filter_level: typing.ClassVar[type] = nodetool.nodes.replicate.image.generate.Imagen_3.Safety_filter_level
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Imagen_3.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Imagen_3.Aspect_ratio._1_1, description='Aspect ratio of the generated image')
    negative_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for what to discourage in the generated images')
    safety_filter_level: nodetool.nodes.replicate.image.generate.Imagen_3.Safety_filter_level = Field(default=nodetool.nodes.replicate.image.generate.Imagen_3.Safety_filter_level.BLOCK_MEDIUM_AND_ABOVE, description='block_low_and_above is strictest, block_medium_and_above blocks some prompts, block_only_high is most permissive but some prompts will still be blocked')

    @classmethod
    def get_node_type(cls): return "replicate.image.generate.Imagen_3"
...
class Kandinsky(GraphNode):
    ...
    width: nodetool.nodes.replicate.image.generate.Kandinsky.Width = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky.Width._512, description='Width of output image. Lower the setting if hits memory limits.')
    height: nodetool.nodes.replicate.image.generate.Kandinsky.Height = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky.Height._512, description='Height of output image. Lower the setting if hits memory limits.')
    ...
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
    output_format: nodetool.nodes.replicate.image.generate.Kandinsky.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky.Output_format.WEBP, description='Output image format')
...
class Kandinsky_2_2(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    width: nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Width = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Width._512, description='Width of output image. Lower the setting if hits memory limits.')
    height: nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Height = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Height._512, description='Height of output image. Lower the setting if hits memory limits.')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='A moss covered astronaut with a black background', description='Input prompt')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
    output_format: nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Output_format = Field(default=nodetool.nodes.replicate.image.generate.Kandinsky_2_2.Output_format.WEBP, description='Output image format')
    negative_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Specify things to not see in the output')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=75, description='Number of denoising steps')
    num_inference_steps_prior: int | GraphNode | tuple[GraphNode, str] = Field(default=25, description='Number of denoising steps for priors')
...
class Photon_Flash(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Set for reproducible generation')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
    aspect_ratio: nodetool.nodes.replicate.image.generate.Photon_Flash.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.Photon_Flash.Aspect_ratio._16_9, description='Aspect ratio of the generated image')
    image_reference_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='URL of a reference image to guide generation')
    style_reference_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='URL of a style reference image')
    ...
    character_reference_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='URL of a character reference image')
...
class PlaygroundV2(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image for img2img or inpaint mode')
    ...
    scheduler: nodetool.nodes.replicate.image.generate.PlaygroundV2.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.PlaygroundV2.Scheduler.DPMSOLVER, description='Scheduler. DPMSolver++ or DPM++2MKarras is recommended for most cases')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
...
class Proteus_V_02(GraphNode):
    ...
    mask: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input mask for inpaint mode. Black areas will be preserved, white areas will be inpainted.')
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image for img2img or inpaint mode')
    width: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Width of output image')
    height: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Height of output image')
    ...
    scheduler: nodetool.nodes.replicate.image.generate.Proteus_V_02.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.Proteus_V_02.Scheduler.KARRASDPM, description='scheduler')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
...
class Proteus_V_03(GraphNode):
    ...
    scheduler: nodetool.nodes.replicate.image.generate.Proteus_V_03.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.Proteus_V_03.Scheduler.DPM__2MSDE, description='scheduler')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Scale for classifier-free guidance. Recommended 7-8')
    apply_watermark: bool | GraphNode | tuple[GraphNode, str] = Field(default=True, description='Applies a watermark to enable determining if an image is generated in downstream applications. If you have other provisions for generating or deploying images safely, you can use this to disable watermarking.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='worst quality, low quality', description='Negative Input prompt')
...
class PulidBase(GraphNode):
    ...
    face_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The face image to use for the generation')
    face_style: nodetool.nodes.replicate.image.generate.PulidBase.Face_style = Field(default=nodetool.nodes.replicate.image.generate.PulidBase.Face_style.HIGH_FIDELITY, description='Style of the face')
    output_format: nodetool.nodes.replicate.image.generate.PulidBase.Output_format = Field(default=nodetool.nodes.replicate.image.generate.PulidBase.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='Things you do not want to see in your image')
    checkpoint_model: nodetool.nodes.replicate.image.generate.PulidBase.Checkpoint_model = Field(default=nodetool.nodes.replicate.image.generate.PulidBase.Checkpoint_model.GENERAL___DREAMSHAPERXL_ALPHA2XL10, description='Model to use for the generation')
...
class Recraft_20B(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_20B.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_20B.Size._1024X1024, description='Width and height of the generated image')
    style: nodetool.nodes.replicate.image.generate.Recraft_20B.Style = Field(default=nodetool.nodes.replicate.image.generate.Recraft_20B.Style.REALISTIC_IMAGE, description='Style of the generated image.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
...
class Recraft_20B_SVG(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Size._1024X1024, description='Width and height of the generated image')
    style: nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Style = Field(default=nodetool.nodes.replicate.image.generate.Recraft_20B_SVG.Style.VECTOR_ILLUSTRATION, description='Style of the generated image.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
...
class Recraft_V3(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_V3.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_V3.Size._1024X1024, description='Width and height of the generated image')
    style: nodetool.nodes.replicate.image.generate.Recraft_V3.Style = Field(default=nodetool.nodes.replicate.image.generate.Recraft_V3.Style.ANY, description='Style of the generated image.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
...
class Recraft_V3_SVG(GraphNode):
    ...
    size: nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Size = Field(default=nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Size._1024X1024, description='Width and height of the generated image')
    style: nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Style = Field(default=nodetool.nodes.replicate.image.generate.Recraft_V3_SVG.Style.ANY, description='Style of the generated image.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt for image generation')
...
class SDXL_Ad_Inpaint(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Remove background from this image')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Describe the new setting for your product')
    img_size: nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Img_size = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Img_size._1024__1024, description='Possible SDXL image sizes')
    ...
    scheduler: nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Scheduler.K_EULER, description='scheduler')
    product_fill: nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Product_fill = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Ad_Inpaint.Product_fill.ORIGINAL, description='What percentage of the image width to fill with product')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Guidance Scale')
...
class SDXL_Emoji(GraphNode):
    ...
    refine: nodetool.nodes.replicate.image.generate.SDXL_Emoji.Refine = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Emoji.Refine.NO_REFINER, description='Which refine style to use')
    scheduler: nodetool.nodes.replicate.image.generate.SDXL_Emoji.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Emoji.Scheduler.K_EULER, description='scheduler')
...
class SDXL_Pixar(GraphNode):
    ...
    height: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Height of output image')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='An astronaut riding a rainbow unicorn', description='Input prompt')
    refine: nodetool.nodes.replicate.image.generate.SDXL_Pixar.Refine = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Pixar.Refine.NO_REFINER, description='Which refine style to use')
    scheduler: nodetool.nodes.replicate.image.generate.SDXL_Pixar.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.SDXL_Pixar.Scheduler.K_EULER, description='scheduler')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.6, description='LoRA additive scale. Only applicable on trained models.')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
    refine_steps: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='For base_image_refiner, the number of steps to refine, defaults to num_inference_steps')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Scale for classifier-free guidance')
...
class StableDiffusion(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    width: nodetool.nodes.replicate.image.generate.StableDiffusion.Width = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion.Width._768, description='Width of generated image in pixels. Needs to be a multiple of 64')
    height: nodetool.nodes.replicate.image.generate.StableDiffusion.Height = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion.Height._768, description='Height of generated image in pixels. Needs to be a multiple of 64')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='a vision of paradise. unreal engine', description='Input prompt')
    scheduler: nodetool.nodes.replicate.image.generate.StableDiffusion.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion.Scheduler.DPMSOLVERMULTISTEP, description='Choose a scheduler.')
...
class StableDiffusion3_5_Large(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Aspect_ratio._1_1, description='The aspect ratio of your output image. This value is ignored if you are using an input image.')
    output_format: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Output_format = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large.Output_format.WEBP, description='Format of the output images')
...
class StableDiffusion3_5_Large_Turbo(GraphNode):
    ...
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='Text prompt for image generation')
    aspect_ratio: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large_Turbo.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large_Turbo.Aspect_ratio._1_1, description='The aspect ratio of your output image. This value is ignored if you are using an input image.')
    output_format: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large_Turbo.Output_format = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Large_Turbo.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=90, description='Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.')
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.85, description='Prompt strength (or denoising strength) when using image to image. 1.0 corresponds to full destruction of information in image.')
...
class StableDiffusion3_5_Medium(GraphNode):
    ...
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='Text prompt for image generation')
    aspect_ratio: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Aspect_ratio = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Aspect_ratio._1_1, description='The aspect ratio of your output image. This value is ignored if you are using an input image.')
    output_format: nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Output_format = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusion3_5_Medium.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=90, description='Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.')
    prompt_strength: float | GraphNode | tuple[GraphNode, str] = Field(default=0.85, description='Prompt strength (or denoising strength) when using image to image. 1.0 corresponds to full destruction of information in image.')
...
class StableDiffusionInpainting(GraphNode):
    ...
    mask: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Black and white image to use as mask for inpainting over the image provided. White pixels are inpainted and black pixels are preserved.')
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Initial image to generate variations of. Will be resized to height x width')
    width: nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Width = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Width._512, description='Width of generated image in pixels. Needs to be a multiple of 64')
    height: nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Height = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Height._512, description='Height of generated image in pixels. Needs to be a multiple of 64')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='a vision of paradise. unreal engine', description='Input prompt')
    scheduler: nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionInpainting.Scheduler.DPMSOLVERMULTISTEP, description='Choose a scheduler.')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to generate.')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Scale for classifier-free guidance')
    negative_prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Specify things to not see in the output')
    num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=50, description='Number of denoising steps')
...
class StableDiffusionXL(GraphNode):
    ...
    height: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Height of output image')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='An astronaut riding a rainbow unicorn', description='Input prompt')
    refine: nodetool.nodes.replicate.image.generate.StableDiffusionXL.Refine = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionXL.Refine.NO_REFINER, description='Which refine style to use')
    scheduler: nodetool.nodes.replicate.image.generate.StableDiffusionXL.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionXL.Scheduler.K_EULER, description='scheduler')
    lora_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=0.6, description='LoRA additive scale. Only applicable on trained models.')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
    refine_steps: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='For base_image_refiner, the number of steps to refine, defaults to num_inference_steps')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=7.5, description='Scale for classifier-free guidance')
...
class StableDiffusionXLLightning(GraphNode):
    ...
    scheduler: nodetool.nodes.replicate.image.generate.StableDiffusionXLLightning.Scheduler = Field(default=nodetool.nodes.replicate.image.generate.StableDiffusionXLLightning.Scheduler.K_EULER, description='scheduler')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output.')
...
class StickerMaker(GraphNode):
    ...
    output_format: nodetool.nodes.replicate.image.generate.StickerMaker.Output_format = Field(default=nodetool.nodes.replicate.image.generate.StickerMaker.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=90, description='Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.')
...
class StyleTransfer(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Set a seed for reproducibility. Random by default.')
    model: nodetool.nodes.replicate.image.generate.StyleTransfer.Model = Field(default=nodetool.nodes.replicate.image.generate.StyleTransfer.Model.FAST, description='Model to use for the generation')
    width: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Width of the output image (ignored if structure image given)')
    height: int | GraphNode | tuple[GraphNode, str] = Field(default=1024, description='Height of the output image (ignored if structure image given)')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='An astronaut riding a unicorn', description='Prompt for the image')
    style_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Copy the style from this image')
    output_format: nodetool.nodes.replicate.image.generate.StyleTransfer.Output_format = Field(default=nodetool.nodes.replicate.image.generate.StyleTransfer.Output_format.WEBP, description='Format of the output images')
    output_quality: int | GraphNode | tuple[GraphNode, str] = Field(default=80, description='Quality of the output images, from 0 to 100. 100 is best quality, 0 is lowest quality.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='', description='Things you do not want to see in your image')
    structure_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='An optional image to copy structure from. Output images will use the same aspect ratio.')
    number_of_images: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to generate')
