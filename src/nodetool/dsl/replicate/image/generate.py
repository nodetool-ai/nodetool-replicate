...
class Qwen_Image_Edit_2511(
    ...
    Aspect_ratio: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Qwen_Image_Edit_2511.Aspect_ratio
    )
    Output_format: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Qwen_Image_Edit_2511.Output_format
    )
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.image.generate.Qwen_Image_Edit_2511.Aspect_ratio(
            "match_input_image"
        ),
        description="Aspect ratio for the generated image.",
    )
    output_format: (
        ...
        default=nodetool.nodes.replicate.image.generate.Qwen_Image_Edit_2511.Output_format(
            "webp"
        ),
        description="Format of the output images.",
    )
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.image.generate.Qwen_Image_Edit_2511
