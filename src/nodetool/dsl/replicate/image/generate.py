...
class Seedream_4_5(SingleOutputGraphNode[types.ImageRef], GraphNode[types.ImageRef]):
    """
    Seedream 4.5: Upgraded Bytedance image model with stronger spatial understanding and world knowledge
    """

    Size: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Seedream_4_5.Size
    )
    Aspect_ratio: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Seedream_4_5.Aspect_ratio
    )
    Sequential_image_generation: typing.ClassVar[type] = (
        nodetool.nodes.replicate.image.generate.Seedream_4_5.Sequential_image_generation
    )

    size: nodetool.nodes.replicate.image.generate.Seedream_4_5.Size = Field(
        default=nodetool.nodes.replicate.image.generate.Seedream_4_5.Size("2K"),
    ...
    aspect_ratio: nodetool.nodes.replicate.image.generate.Seedream_4_5.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.image.generate.Seedream_4_5.Aspect_ratio(
                "match_input_image"
            ),
            description="Image aspect ratio. Only used when size is not 'custom'. Use 'match_input_image' to automatically match the input image's aspect ratio.",
        )
    ...
    sequential_image_generation: (
        ...
        default=nodetool.nodes.replicate.image.generate.Seedream_4_5.Sequential_image_generation(
            "disabled"
        ),
        description="Group image generation mode. 'disabled' generates a single image. 'auto' lets the model decide whether to generate multiple related images (e.g., story scenes, character variations).",
    )
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.image.generate.Seedream_4_5
