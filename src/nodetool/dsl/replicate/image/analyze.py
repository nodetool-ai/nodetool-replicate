...
class Blip(GraphNode):
    ...
    caption: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
        description="Type caption for the input image for image text matching task.",
    )
    question: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    def get_node_type(cls):
        return "replicate.image.analyze.Blip"
...
class Blip2(GraphNode):
    ...
    caption: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
        description="Select if you want to generate image captions instead of asking questions",
    )
    context: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    use_nucleus_sampling: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.Blip2"
...
class ClipFeatures(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.ClipFeatures"
...
class ClipInterrogator(GraphNode):
    ...
    clip_model_name: (
        ...
        default=nodetool.nodes.replicate.image.analyze.ClipInterrogator.Clip_model_name.VIT_L_14_OPENAI,
        description="Choose ViT-L for Stable Diffusion 1, ViT-H for Stable Diffusion 2, or ViT-bigG for Stable Diffusion XL.",
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.ClipInterrogator"
...
class Img2Prompt(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.Img2Prompt"
...
class Llava13b(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.Llava13b"
...
class Moondream2(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.Moondream2"
...
class NSFWImageDetection(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.NSFWImageDetection"
...
class SDXLClipInterrogator(GraphNode):
    ...
    mode: nodetool.nodes.replicate.image.analyze.SDXLClipInterrogator.Mode = Field(
        default=nodetool.nodes.replicate.image.analyze.SDXLClipInterrogator.Mode.BEST,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.analyze.SDXLClipInterrogator"
