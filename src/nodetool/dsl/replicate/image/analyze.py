...
class Blip2(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image to query or caption')
...
class ClipInterrogator(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image')
    clip_model_name: nodetool.nodes.replicate.image.analyze.ClipInterrogator.Clip_model_name = Field(default=nodetool.nodes.replicate.image.analyze.ClipInterrogator.Clip_model_name.VIT_L_14_OPENAI, description='Choose ViT-L for Stable Diffusion 1, ViT-H for Stable Diffusion 2, or ViT-bigG for Stable Diffusion XL.')
