...
class ClarityUpscaler(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='input image')
    ...
    handfix: nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Handfix = Field(default=nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Handfix.DISABLED, description='Use clarity to fix hands in the image')
    ...
    sd_model: nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Sd_model = Field(default=nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Sd_model.JUGGERNAUT_REBORN_SAFETENSORS__338B85BC4F, description='Stable Diffusion model checkpoint')
    scheduler: nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Scheduler = Field(default=nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Scheduler.DPM___3M_SDE_KARRAS, description='scheduler')
    ...
    tiling_width: nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Tiling_width = Field(default=nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Tiling_width._112, description='Fractality, set lower tile width for a high Fractality')
    output_format: nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Output_format = Field(default=nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Output_format.PNG, description='Format of the output images')
    tiling_height: nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Tiling_height = Field(default=nodetool.nodes.replicate.image.upscale.ClarityUpscaler.Tiling_height._144, description='Fractality, set lower tile height for a high Fractality')
...
class GFPGAN(GraphNode):
    ...
    img: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input')
    scale: float | GraphNode | tuple[GraphNode, str] = Field(default=2, description='Rescaling factor')
    version: nodetool.nodes.replicate.image.upscale.GFPGAN.Version = Field(default=nodetool.nodes.replicate.image.upscale.GFPGAN.Version.V1_4, description='GFPGAN version. v1.3: better quality. v1.4: more details and better identity.')
...
class HighResolutionControlNetTile(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Control image for scribble controlnet')
    steps: int | GraphNode | tuple[GraphNode, str] = Field(default=8, description='Steps')
    format: nodetool.nodes.replicate.image.upscale.HighResolutionControlNetTile.Format = Field(default=nodetool.nodes.replicate.image.upscale.HighResolutionControlNetTile.Format.JPG, description='Format of the output.')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for the model')
    scheduler: nodetool.nodes.replicate.image.upscale.HighResolutionControlNetTile.Scheduler = Field(default=nodetool.nodes.replicate.image.upscale.HighResolutionControlNetTile.Scheduler.DDIM, description='Choose a scheduler.')
    ...
    resolution: nodetool.nodes.replicate.image.upscale.HighResolutionControlNetTile.Resolution = Field(default=nodetool.nodes.replicate.image.upscale.HighResolutionControlNetTile.Resolution._2560, description='Image resolution')
...
class MagicImageRefiner(GraphNode):
    ...
    hdr: float | GraphNode | tuple[GraphNode, str] = Field(default=0, description='HDR improvement over the original image')
    mask: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='When provided, refines some section of the image. Must be the same size as the image')
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Seed')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Image to refine')
    steps: int | GraphNode | tuple[GraphNode, str] = Field(default=20, description='Steps')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for the model')
    scheduler: nodetool.nodes.replicate.image.upscale.MagicImageRefiner.Scheduler = Field(default=nodetool.nodes.replicate.image.upscale.MagicImageRefiner.Scheduler.DDIM, description='Choose a scheduler.')
    ...
    resolution: nodetool.nodes.replicate.image.upscale.MagicImageRefiner.Resolution = Field(default=nodetool.nodes.replicate.image.upscale.MagicImageRefiner.Resolution.ORIGINAL, description='Image resolution')
...
class Swin2SR(GraphNode):
    ...
    task: nodetool.nodes.replicate.image.upscale.Swin2SR.Task = Field(default=nodetool.nodes.replicate.image.upscale.Swin2SR.Task.REAL_SR, description='Choose a task')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image')
...
class SwinIR(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='input image')
    noise: nodetool.nodes.replicate.image.upscale.SwinIR.Noise = Field(default=nodetool.nodes.replicate.image.upscale.SwinIR.Noise._15, description='noise level, activated for Grayscale Image Denoising and Color Image Denoising. Leave it as default or arbitrary if other tasks are selected')
    task_type: nodetool.nodes.replicate.image.upscale.SwinIR.Task_type = Field(default=nodetool.nodes.replicate.image.upscale.SwinIR.Task_type.REAL_WORLD_IMAGE_SUPER_RESOLUTION_LARGE, description='Choose a task')
...
class UltimateSDUpscale(GraphNode):
    ...
    upscaler: nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Upscaler = Field(default=nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Upscaler._4X_ULTRASHARP, description='Upscaler')
    mask_blur: int | GraphNode | tuple[GraphNode, str] = Field(default=8, description='Mask Blur')
    mode_type: nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Mode_type = Field(default=nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Mode_type.LINEAR, description='Mode Type')
    scheduler: nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Scheduler = Field(default=nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Scheduler.NORMAL, description='Scheduler')
    ...
    sampler_name: nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Sampler_name = Field(default=nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Sampler_name.EULER, description='Sampler')
    tile_padding: int | GraphNode | tuple[GraphNode, str] = Field(default=32, description='Tile Padding')
    seam_fix_mode: nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Seam_fix_mode = Field(default=nodetool.nodes.replicate.image.upscale.UltimateSDUpscale.Seam_fix_mode.NONE, description='Seam Fix Mode')
...
class ruDallE_SR(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image')
    scale: nodetool.nodes.replicate.image.upscale.ruDallE_SR.Scale = Field(default=nodetool.nodes.replicate.image.upscale.ruDallE_SR.Scale._4, description='Choose up-scaling factor')
