...
class BecomeImage(GraphNode):
    ...
    image_to_become: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    denoising_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1,
    ...
    instant_id_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="How strong the InstantID will be."
    )
    image_to_become_noise: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.3,
        description="How much noise to add to the style image before processing. An alternative way of controlling stength.",
    )
    control_depth_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.8,
    ...
    image_to_become_strength: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.75, description="How strong the style will be applied"
    )

    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.BecomeImage"
...
class FaceToMany(GraphNode):
    ...
    style: nodetool.nodes.replicate.image.face.FaceToMany.Style = Field(
        default=nodetool.nodes.replicate.image.face.FaceToMany.Style._3D,
    ...
    custom_lora_url: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.FaceToMany"
...
class FaceToSticker(GraphNode):
    ...
    upscale: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False, description="2x upscale the sticker"
    )
    upscale_steps: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    ip_adapter_noise: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.5, description="How much noise is added to the IP adapter input"
    )
    ip_adapter_weight: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.FaceToSticker"
...
class InstantId(GraphNode):
    ...
    scheduler: nodetool.nodes.replicate.image.face.InstantId.Scheduler = Field(
        default=nodetool.nodes.replicate.image.face.InstantId.Scheduler.EULERDISCRETESCHEDULER,
        description="Scheduler",
    )
    enable_lcm: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
    ...
    pose_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
    ...
    sdxl_weights: nodetool.nodes.replicate.image.face.InstantId.Sdxl_weights = Field(
        default=nodetool.nodes.replicate.image.face.InstantId.Sdxl_weights.STABLE_DIFFUSION_XL_BASE_1_0,
    ...
    lcm_guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1.5,
    ...
    enable_pose_controlnet: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True,
        description="Enable Openpose ControlNet, overrides strength if set to false",
    )
    enhance_nonface_region: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=True, description="Enhance non-face region"
    )
    enable_canny_controlnet: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
        description="Enable Canny ControlNet, overrides strength if set to false",
    )
    enable_depth_controlnet: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
        description="Enable Depth ControlNet, overrides strength if set to false",
    )
    lcm_num_inference_steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=5,
        description="Only used when `enable_lcm` is set to True, Number of denoising steps when using LCM",
    )
    face_detection_input_width: int | GraphNode | tuple[GraphNode, str] = Field(
        default=640, description="Width of the input image for face detection"
    )
    face_detection_input_height: int | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.InstantId"
...
class Instant_ID_Artistic(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.Instant_ID_Artistic"
...
class Instant_ID_Photorealistic(GraphNode):
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.Instant_ID_Photorealistic"
...
class PhotoMaker(GraphNode):
    ...
    style_name: nodetool.nodes.replicate.image.face.PhotoMaker.Style_name = Field(
        default=nodetool.nodes.replicate.image.face.PhotoMaker.Style_name.PHOTOGRAPHIC__DEFAULT,
        description="Style template. The style template will add a style-specific prompt and negative prompt to the user's prompt.",
    )
    input_image: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="The input image, for example a photo of your face."
    )
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(
        default=1, description="Number of output images"
    )
    input_image2: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="Additional input image (optional)"
    )
    input_image3: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="Additional input image (optional)"
    )
    input_image4: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None, description="Additional input image (optional)"
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=5,
    ...
    style_strength_ratio: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.PhotoMaker"
...
class PhotoMakerStyle(GraphNode):
    ...
    style_name: nodetool.nodes.replicate.image.face.PhotoMakerStyle.Style_name = Field(
        default=nodetool.nodes.replicate.image.face.PhotoMakerStyle.Style_name.NO_STYLE,
        description="Style template. The style template will add a style-specific prompt and negative prompt to the user's prompt.",
    )
    ...
    input_image2: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="Additional input image (optional)",
    )
    input_image3: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="Additional input image (optional)",
    )
    input_image4: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.ImageRef(type="image", uri="", asset_id=None, data=None),
        description="Additional input image (optional)",
    )
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.image.face.PhotoMakerStyle"
