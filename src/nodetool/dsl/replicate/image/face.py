...
class BecomeImage(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='An image of a person to be converted')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='a person', description=None)
    image_to_become: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Any image to convert the person to')
...
class FaceToMany(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Fix the random seed for reproducibility')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='An image of a person to be converted')
    style: nodetool.nodes.replicate.image.face.FaceToMany.Style = Field(default=nodetool.nodes.replicate.image.face.FaceToMany.Style._3D, description='Style to convert to')
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='a person', description=None)
...
class FaceToSticker(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Fix the random seed for reproducibility')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='An image of a person to be converted to a sticker')
...
class InstantId(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input face image')
    ...
    pose_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='(Optional) reference pose image')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of images to output')
    sdxl_weights: nodetool.nodes.replicate.image.face.InstantId.Sdxl_weights = Field(default=nodetool.nodes.replicate.image.face.InstantId.Sdxl_weights.STABLE_DIFFUSION_XL_BASE_1_0, description='Pick which base weights you want to use')
...
class PhotoMaker(GraphNode):
    ...
    style_name: nodetool.nodes.replicate.image.face.PhotoMaker.Style_name = Field(default=nodetool.nodes.replicate.image.face.PhotoMaker.Style_name.PHOTOGRAPHIC__DEFAULT, description="Style template. The style template will add a style-specific prompt and negative prompt to the user's prompt.")
...
class PhotoMakerStyle(GraphNode):
    ...
    prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='A photo of a person img', description="Prompt. Example: 'a photo of a man/woman img'. The phrase 'img' is the trigger word.")
    num_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=20, description='Number of sample steps')
    style_name: nodetool.nodes.replicate.image.face.PhotoMakerStyle.Style_name = Field(default=nodetool.nodes.replicate.image.face.PhotoMakerStyle.Style_name.NO_STYLE, description="Style template. The style template will add a style-specific prompt and negative prompt to the user's prompt.")
    input_image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='The input image, for example a photo of your face.')
    num_outputs: int | GraphNode | tuple[GraphNode, str] = Field(default=1, description='Number of output images')
    input_image2: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Additional input image (optional)')
    input_image3: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Additional input image (optional)')
    input_image4: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Additional input image (optional)')
    guidance_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=5, description='Guidance scale. A guidance scale of 1 corresponds to doing no classifier free guidance.')
    negative_prompt: str | GraphNode | tuple[GraphNode, str] = Field(default='nsfw, lowres, bad anatomy, bad hands, text, error, missing fingers, extra digit, fewer digits, cropped, worst quality, low quality, normal quality, jpeg artifacts, signature, watermark, username, blurry', description='Negative Prompt. The negative prompt should NOT contain the trigger word.')
    style_strength_ratio: float | GraphNode | tuple[GraphNode, str] = Field(default=20, description='Style strength (%)')
    disable_safety_checker: bool | GraphNode | tuple[GraphNode, str] = Field(default=False, description='Disable safety checker for generated images.')
