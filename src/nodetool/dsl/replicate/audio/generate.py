...
class Inworld_TTS_1_5_Max(
    ...
    Sample_rate: typing.ClassVar[type] = (
        nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Max.Sample_rate
    )
    Audio_format: typing.ClassVar[type] = (
        nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Max.Audio_format
    )
    Text_normalization: typing.ClassVar[type] = (
        nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Max.Text_normalization
    )
    ...
    sample_rate: (
        ...
        default=nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Max.Sample_rate(
            48000
        ),
    ...
    audio_format: (
        ...
        default=nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Max.Audio_format(
            "mp3"
        ),
    ...
    text_normalization: (
        ...
        default=nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Max.Text_normalization(
            "auto"
        ),
    ...
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Max
...
class Inworld_TTS_1_5_Mini(
    ...
    Sample_rate: typing.ClassVar[type] = (
        nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Mini.Sample_rate
    )
    Audio_format: typing.ClassVar[type] = (
        nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Mini.Audio_format
    )
    Text_normalization: typing.ClassVar[type] = (
        nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Mini.Text_normalization
    )
    ...
    sample_rate: (
        ...
        default=nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Mini.Sample_rate(
            48000
        ),
        description="Audio sample rate in Hz.",
    )
    ...
    audio_format: (
        ...
        default=nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Mini.Audio_format(
            "mp3"
        ),
        description="Output audio format.",
    )
    ...
    text_normalization: (
        ...
        default=nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Mini.Text_normalization(
            "auto"
        ),
        description="Controls whether numbers, dates, and abbreviations are expanded before synthesis. 'auto' lets the model decide, 'on' always normalizes, 'off' reads text as-is.",
    )
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.audio.generate.Inworld_TTS_1_5_Mini
...
class Lyria_2(SingleOutputGraphNode[types.AudioRef], GraphNode[types.AudioRef]):
    ...
    prompt: str | OutputHandle[str] | None = connect_field(
        default=None, description="Text prompt for audio generation"
    )
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.audio.generate.Lyria_2
