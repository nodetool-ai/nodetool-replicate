...
class MMAudio(GraphNode):
    ...
    seed: int | GraphNode | tuple[GraphNode, str] = Field(
        default=-1, description="Random seed. Use -1 to randomize the seed"
    )
    video: str | None | GraphNode | tuple[GraphNode, str] = Field(
    ...
    def get_node_type(cls):
        return "replicate.audio.generate.MMAudio"
...
class MusicGen(GraphNode):
    ...
    duration: int | GraphNode | tuple[GraphNode, str] = Field(
        default=8, description="Duration of the generated audio in seconds."
    )
    input_audio: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    continuation: bool | GraphNode | tuple[GraphNode, str] = Field(
        default=False,
    ...
    model_version: nodetool.nodes.replicate.audio.generate.MusicGen.Model_version = (
        Field(
            default=nodetool.nodes.replicate.audio.generate.MusicGen.Model_version.STEREO_MELODY_LARGE,
    ...
    normalization_strategy: (
        ...
        default=nodetool.nodes.replicate.audio.generate.MusicGen.Normalization_strategy.LOUDNESS,
        description="Strategy for normalizing audio.",
    )
    classifier_free_guidance: int | GraphNode | tuple[GraphNode, str] = Field(
        default=3,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.audio.generate.MusicGen"
...
class RealisticVoiceCloning(GraphNode):
    ...
    protect: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.33,
    ...
    rvc_model: (
        ...
        default=nodetool.nodes.replicate.audio.generate.RealisticVoiceCloning.Rvc_model.SQUIDWARD,
    ...
    output_format: (
        ...
        default=nodetool.nodes.replicate.audio.generate.RealisticVoiceCloning.Output_format.MP3,
        description="wav for best quality and large file size, mp3 for decent quality and small file size.",
    )
    reverb_damping: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.7, description="Absorption of high frequencies in the reverb."
    )
    reverb_dryness: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.8, description="Level of AI vocals without reverb."
    )
    reverb_wetness: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.2, description="Level of AI vocals with reverb."
    )
    crepe_hop_length: int | GraphNode | tuple[GraphNode, str] = Field(
        default=128,
    ...
    pitch_change_all: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0,
        description="Change pitch/key of background music, backup vocals and AI vocals in semitones. Reduces sound quality slightly.",
    )
    main_vocals_volume_change: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0,
    ...
    pitch_detection_algorithm: (
        ...
        default=nodetool.nodes.replicate.audio.generate.RealisticVoiceCloning.Pitch_detection_algorithm.RMVPE,
        description="Best option is rmvpe (clarity in vocals), then mangio-crepe (smoother vocals).",
    )
    instrumental_volume_change: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0, description="Control volume of the background music/instrumentals."
    )
    backup_vocals_volume_change: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0, description="Control volume of backup AI vocals."
    )
    custom_rvc_model_download_url: str | None | GraphNode | tuple[GraphNode, str] = (
        Field(
            default=None,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.audio.generate.RealisticVoiceCloning"
...
class Riffusion(GraphNode):
    ...
    seed_image_id: nodetool.nodes.replicate.audio.generate.Riffusion.Seed_image_id = (
        Field(
            default=nodetool.nodes.replicate.audio.generate.Riffusion.Seed_image_id.VIBES,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.audio.generate.Riffusion"


class StyleTTS2(GraphNode):
    """Generates speech from text"""

    beta: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0.7,
    ...
    text: str | None | GraphNode | tuple[GraphNode, str] = Field(
    ...
    weights: str | None | GraphNode | tuple[GraphNode, str] = Field(
        default=None,
    ...
    reference: types.AudioRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.AudioRef(type="audio", uri="", asset_id=None, data=None),
        description="Reference speech to copy style from",
    )
    diffusion_steps: int | GraphNode | tuple[GraphNode, str] = Field(
        default=10, description="Number of diffusion steps"
    )
    embedding_scale: float | GraphNode | tuple[GraphNode, str] = Field(
        default=1,
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.audio.generate.StyleTTS2"
...
class TortoiseTTS(GraphNode):
    ...
    cvvp_amount: float | GraphNode | tuple[GraphNode, str] = Field(
        default=0,
    ...
    custom_voice: types.AudioRef | GraphNode | tuple[GraphNode, str] = Field(
        default=types.AudioRef(type="audio", uri="", asset_id=None, data=None),
    ...
    @classmethod
    def get_node_type(cls):
        return "replicate.audio.generate.TortoiseTTS"
