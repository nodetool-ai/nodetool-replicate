...
class AudioSuperResolution(GraphNode):
    ...
    input_file: types.AudioRef | GraphNode | tuple[GraphNode, str] = Field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None), description='Audio to upsample')
