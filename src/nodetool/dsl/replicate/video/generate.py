...
class AudioToWaveform(GraphNode):
    ...
    audio: types.AudioRef | GraphNode | tuple[GraphNode, str] = Field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None), description='Audio file to create waveform from')
...
class HotshotXL(GraphNode):
    ...
    width: nodetool.nodes.replicate.video.generate.HotshotXL.Width = Field(default=nodetool.nodes.replicate.video.generate.HotshotXL.Width._672, description='Width of the output')
    height: nodetool.nodes.replicate.video.generate.HotshotXL.Height = Field(default=nodetool.nodes.replicate.video.generate.HotshotXL.Height._384, description='Height of the output')
    ...
    scheduler: nodetool.nodes.replicate.video.generate.HotshotXL.Scheduler = Field(default=nodetool.nodes.replicate.video.generate.HotshotXL.Scheduler.EULERANCESTRALDISCRETESCHEDULER, description='Select a Scheduler')
...
class LTX_Video(GraphNode):
    ...
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Optional input image to use as the starting frame')
    model: nodetool.nodes.replicate.video.generate.LTX_Video.Model = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Model._0_9_1, description='Model version to use')
    steps: int | GraphNode | tuple[GraphNode, str] = Field(default=30, description='Number of steps')
    length: nodetool.nodes.replicate.video.generate.LTX_Video.Length = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Length._97, description='Length of the output video in frames')
    ...
    target_size: nodetool.nodes.replicate.video.generate.LTX_Video.Target_size = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Target_size._640, description='Target size for the output video')
    aspect_ratio: nodetool.nodes.replicate.video.generate.LTX_Video.Aspect_ratio = Field(default=nodetool.nodes.replicate.video.generate.LTX_Video.Aspect_ratio._3_2, description='Aspect ratio of the output video. Ignored if an image is provided.')
...
class Music_01(GraphNode):
    ...
    bitrate: nodetool.nodes.replicate.video.generate.Music_01.Bitrate = Field(default=nodetool.nodes.replicate.video.generate.Music_01.Bitrate._256000, description='Bitrate for the generated music')
    voice_id: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Reuse a previously uploaded voice ID')
    song_file: types.AudioRef | GraphNode | tuple[GraphNode, str] = Field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None), description='Reference song, should contain music and vocals. Must be a .wav or .mp3 file longer than 15 seconds.')
    voice_file: types.AudioRef | GraphNode | tuple[GraphNode, str] = Field(default=types.AudioRef(type='audio', uri='', asset_id=None, data=None), description='Voice reference. Must be a .wav or .mp3 file longer than 15 seconds. If only a voice reference is given, an a cappella vocal hum will be generated.')
    sample_rate: nodetool.nodes.replicate.video.generate.Music_01.Sample_rate = Field(default=nodetool.nodes.replicate.video.generate.Music_01.Sample_rate._44100, description='Sample rate for the generated music')
...
class Ray(GraphNode):
    ...
    aspect_ratio: nodetool.nodes.replicate.video.generate.Ray.Aspect_ratio = Field(default=nodetool.nodes.replicate.video.generate.Ray.Aspect_ratio._16_9, description="Aspect ratio of the video (e.g. '16:9'). Ignored if a start or end frame or video ID is given.")
    ...
    end_image_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='URL of an image to use as the ending frame')
    ...
    start_image_url: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='URL of an image to use as the starting frame')
...
class RobustVideoMatting(GraphNode):
    ...
    input_video: types.VideoRef | GraphNode | tuple[GraphNode, str] = Field(default=types.VideoRef(type='video', uri='', asset_id=None, data=None, duration=None, format=None), description='Video to segment.')
    output_type: nodetool.nodes.replicate.video.generate.RobustVideoMatting.Output_type = Field(default=nodetool.nodes.replicate.video.generate.RobustVideoMatting.Output_type.GREEN_SCREEN, description=None)
...
class Video_01(GraphNode):
    ...
    first_frame_image: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='First frame image for video generation. The output video will have the same aspect ratio as this image.')
    subject_reference: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='An optional character reference image to use as the subject in the generated video')
...
class Wan_2_1_1_3B(GraphNode):
    ...
    Frame_num: typing.ClassVar[type] = nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Frame_num
    Resolution: typing.ClassVar[type] = nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Resolution
    Aspect_ratio: typing.ClassVar[type] = nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Aspect_ratio
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed for reproducible results (leave blank for random)')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Text prompt describing what you want to generate')
    frame_num: nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Frame_num = Field(default=nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Frame_num._81, description='Video duration in frames (based on standard 16fps playback)')
    resolution: nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Resolution = Field(default=nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Resolution._480P, description='Video resolution')
    aspect_ratio: nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Aspect_ratio = Field(default=nodetool.nodes.replicate.video.generate.Wan_2_1_1_3B.Aspect_ratio._16_9, description='Video aspect ratio')
    sample_shift: float | GraphNode | tuple[GraphNode, str] = Field(default=8, description='Sampling shift factor for flow matching (recommended range: 8-12)')
    sample_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=30, description='Number of sampling steps (higher = better quality but slower)')
    sample_guide_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=6, description='Classifier free guidance scale (higher values strengthen prompt adherence)')

    @classmethod
    def get_node_type(cls): return "replicate.video.generate.Wan_2_1_1_3B"
...
class Wan_2_1_I2V_480p(GraphNode):
    ...
    Max_area: typing.ClassVar[type] = nodetool.nodes.replicate.video.generate.Wan_2_1_I2V_480p.Max_area
    Fast_mode: typing.ClassVar[type] = nodetool.nodes.replicate.video.generate.Wan_2_1_I2V_480p.Fast_mode
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank for random')
    image: types.ImageRef | GraphNode | tuple[GraphNode, str] = Field(default=types.ImageRef(type='image', uri='', asset_id=None, data=None), description='Input image to start generating from')
    prompt: str | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Prompt for video generation')
    max_area: nodetool.nodes.replicate.video.generate.Wan_2_1_I2V_480p.Max_area = Field(default=nodetool.nodes.replicate.video.generate.Wan_2_1_I2V_480p.Max_area._832X480, description='Maximum area of generated image. The input image will shrink to fit these dimensions')
    fast_mode: nodetool.nodes.replicate.video.generate.Wan_2_1_I2V_480p.Fast_mode = Field(default=nodetool.nodes.replicate.video.generate.Wan_2_1_I2V_480p.Fast_mode.OFF, description='Speed up generation with different levels of acceleration. Faster modes may degrade quality somewhat. The speedup is dependent on the content, so different videos may see different speedups.')
    num_frames: int | GraphNode | tuple[GraphNode, str] = Field(default=81, description='Number of video frames')
    sample_shift: float | GraphNode | tuple[GraphNode, str] = Field(default=3, description='Sample shift factor')
    sample_steps: int | GraphNode | tuple[GraphNode, str] = Field(default=30, description='Number of generation steps. Fewer steps means faster generation, at the expensive of output quality. 30 steps is sufficient for most prompts')
    frames_per_second: int | GraphNode | tuple[GraphNode, str] = Field(default=16, description='Frames per second. Note that the pricing of this model is based on the video duration at 16 fps')
    sample_guide_scale: float | GraphNode | tuple[GraphNode, str] = Field(default=5, description='Higher guide scale makes prompt adherence better, but can reduce variation')

    @classmethod
    def get_node_type(cls): return "replicate.video.generate.Wan_2_1_I2V_480p"
...
class Zeroscope_V2_XL(GraphNode):
    ...
    seed: int | None | GraphNode | tuple[GraphNode, str] = Field(default=None, description='Random seed. Leave blank to randomize the seed')
    model: nodetool.nodes.replicate.video.generate.Zeroscope_V2_XL.Model = Field(default=nodetool.nodes.replicate.video.generate.Zeroscope_V2_XL.Model.XL, description='Model to use')
