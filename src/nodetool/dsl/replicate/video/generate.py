...
class Seedance_1_5_Pro(
    ...
    Fps: typing.ClassVar[type] = (
        nodetool.nodes.replicate.video.generate.Seedance_1_5_Pro.Fps
    )
    Aspect_ratio: typing.ClassVar[type] = (
        nodetool.nodes.replicate.video.generate.Seedance_1_5_Pro.Aspect_ratio
    )

    fps: nodetool.nodes.replicate.video.generate.Seedance_1_5_Pro.Fps = Field(
        default=nodetool.nodes.replicate.video.generate.Seedance_1_5_Pro.Fps(24),
    ...
    image: str | OutputHandle[str] | None = connect_field(
        default=None, description="Input image for image-to-video generation"
    )
    prompt: str | OutputHandle[str] | None = connect_field(
        default=None, description="Text prompt for video generation"
    )
    ...
    aspect_ratio: (
        ...
        default=nodetool.nodes.replicate.video.generate.Seedance_1_5_Pro.Aspect_ratio(
            "16:9"
        ),
        description="Video aspect ratio. Ignored if an image is used.",
    )
    camera_fixed: bool | OutputHandle[bool] = connect_field(
        default=False, description="Whether to fix camera position"
    )
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.video.generate.Seedance_1_5_Pro
