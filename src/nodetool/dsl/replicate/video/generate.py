...
class Kling_V2_6(SingleOutputGraphNode[types.VideoRef], GraphNode[types.VideoRef]):
    """
    Kling 2.6 Pro: Top-tier image-to-video with cinematic visuals, fluid motion, and native audio generation
    """

    Duration: typing.ClassVar[type] = (
        nodetool.nodes.replicate.video.generate.Kling_V2_6.Duration
    )
    Aspect_ratio: typing.ClassVar[type] = (
        nodetool.nodes.replicate.video.generate.Kling_V2_6.Aspect_ratio
    )

    prompt: str | OutputHandle[str] | None = connect_field(
        default=None, description="Text prompt for video generation"
    )
    duration: nodetool.nodes.replicate.video.generate.Kling_V2_6.Duration = Field(
        default=nodetool.nodes.replicate.video.generate.Kling_V2_6.Duration(5),
        description="Duration of the video in seconds",
    )
    start_image: str | OutputHandle[str] | None = connect_field(
        default=None, description="First frame of the video"
    )
    aspect_ratio: nodetool.nodes.replicate.video.generate.Kling_V2_6.Aspect_ratio = (
        Field(
            default=nodetool.nodes.replicate.video.generate.Kling_V2_6.Aspect_ratio(
                "16:9"
            ),
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.video.generate.Kling_V2_6
...
class Veo_3_1(SingleOutputGraphNode[types.VideoRef], GraphNode[types.VideoRef]):
    ...
    Duration: typing.ClassVar[type] = (
        nodetool.nodes.replicate.video.generate.Veo_3_1.Duration
    )
    Resolution: typing.ClassVar[type] = (
        nodetool.nodes.replicate.video.generate.Veo_3_1.Resolution
    )
    Aspect_ratio: typing.ClassVar[type] = (
        nodetool.nodes.replicate.video.generate.Veo_3_1.Aspect_ratio
    )
    ...
    duration: nodetool.nodes.replicate.video.generate.Veo_3_1.Duration = Field(
        default=nodetool.nodes.replicate.video.generate.Veo_3_1.Duration(8),
        description="Video duration in seconds",
    )
    last_frame: str | OutputHandle[str] | None = connect_field(
        default=None,
        description="Ending image for interpolation. When provided with an input image, creates a transition between the two images.",
    )
    resolution: nodetool.nodes.replicate.video.generate.Veo_3_1.Resolution = Field(
        default=nodetool.nodes.replicate.video.generate.Veo_3_1.Resolution("1080p"),
        description="Resolution of the generated video",
    )
    aspect_ratio: nodetool.nodes.replicate.video.generate.Veo_3_1.Aspect_ratio = Field(
        default=nodetool.nodes.replicate.video.generate.Veo_3_1.Aspect_ratio("16:9"),
        description="Video aspect ratio",
    )
    generate_audio: bool | OutputHandle[bool] = connect_field(
    ...
    @classmethod
    def get_node_class(cls) -> type[BaseNode]:
        return nodetool.nodes.replicate.video.generate.Veo_3_1
...
class Wan_2_2_I2V_Fast(
    ...
    last_image: str | OutputHandle[str] | None = connect_field(
        default=None,
    ...
    interpolate_output: bool | OutputHandle[bool] = connect_field(
        default=False,
    ...
    lora_scale_transformer: float | OutputHandle[float] = connect_field(
        default=1,
        description="Determines how strongly the transformer LoRA should be applied.",
    )
    lora_scale_transformer_2: float | OutputHandle[float] = connect_field(
        default=1,
        description="Determines how strongly the transformer_2 LoRA should be applied.",
    )
    lora_weights_transformer: str | OutputHandle[str] | None = connect_field(
        default=None,
    ...
    lora_weights_transformer_2: str | OutputHandle[str] | None = connect_field(
        default=None,
...
class Wan_2_2_T2V_Fast(
    ...
    optimize_prompt: bool | OutputHandle[bool] = connect_field(
        default=False, description="Translate prompt to Chinese before generation"
    )
    frames_per_second: int | OutputHandle[int] = connect_field(
        default=16,
        description="Frames per second. Note that the pricing of this model is based on the video duration at 16 fps",
