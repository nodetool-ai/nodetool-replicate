...
class Seedance_1_5_Pro(ReplicateNode):
    ...
    @classmethod
    def get_basic_fields(cls):
        return ["fps", "seed", "image"]

    @classmethod
    def replicate_model_id(cls):
        return "bytedance/seedance-1.5-pro:78c1986fecf4df185593bbf148a0ed5b4b18b7e0e0f34cc3e32c68cdfa9536ba"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/54474a30-fff9-4064-90c7-f94850be185f/seedance-1.5-pro-sm.mp4",
            "created_at": "2025-12-23T17:52:51.203911Z",
    ...
    fps: Fps = Field(description="Frame rate (frames per second)", default=24)
    seed: int | None = Field(
        title="Seed",
        description="Random seed. Set for reproducible generation",
        default=None,
    ...
    aspect_ratio: Aspect_ratio = Field(
        description="Video aspect ratio. Ignored if an image is used.", default="16:9"
    )
