...
class Veo_3_1(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "google/veo-3.1:9c6ca0c25d89ac6102278405a0673fd929b7793856870d2718e3a84a5aa4ad4d"
...
class Gen_4_5(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "runwayml/gen-4.5:2e10d5ae08888b39ed31c828003f4a5ddc89a7cdec3bc7a9926661e0d22cb034"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://replicate.delivery/xezq/AlfC7qolTq1YXysS5Aak9WavhusB7WtrgUu6GEpZCoBIlWELA/tmp82ivy7af.mp4",
            "created_at": "2026-02-18T00:12:28.127167Z",
            ...
            "paper_url": None,
            "run_count": 109638,
            "url": "https://replicate.com/runwayml/gen-4.5",
            "visibility": "public",
            "weights_url": None,
        }
...
class Grok_Imagine_Video(ReplicateNode):
    ...
    @classmethod
    def get_basic_fields(cls):
        return ["image", "video", "prompt"]

    @classmethod
    def replicate_model_id(cls):
        return "xai/grok-imagine-video:ee86ec3a213afbf7782408ca5377d90a3d36d9909ab380a603dfabd4859c8c6a"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/620af820-96e6-4854-9ae8-81d1226e4f75/Grok_Imagine_Video.mp4",
            "created_at": "2026-02-05T20:24:55.905347Z",
            ...
            "paper_url": None,
            "run_count": 495935,
            "url": "https://replicate.com/xai/grok-imagine-video",
            "visibility": "public",
            "weights_url": None,
        }
    ...
    aspect_ratio: Aspect_ratio = Field(
        description="Aspect ratio of the video. For text-to-video, defaults to 16:9. For image-to-video, defaults to the input image's native aspect ratio. Ignored when editing a video.",
        default="auto",
    )


class Kling_V3_Motion_Control(ReplicateNode):
    ...
    class Character_orientation(str, Enum):
        IMAGE = "image"
        VIDEO = "video"

    @classmethod
    def get_basic_fields(cls):
        return ["mode", "image", "video"]

    @classmethod
    def replicate_model_id(cls):
        return "kwaivgi/kling-v3-motion-control:15430b300f8c044e8f9e3567fd6daadf6d62e9bb0cee23fdb7969d3b26542f40"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://replicate.delivery/xezq/i748h9oPvLp6Ktupd1oFRcNbzcGl5j9gZCfDyHsv4MrN07GLA/tmp7gzjazeo.mp4",
            "created_at": "2026-03-05T16:50:16.385004Z",
            ...
            "github_url": "https://github.com/replicate/cog-kwai-proxy",
            "license_url": None,
            ...
            "paper_url": None,
            "run_count": 115422,
            "url": "https://replicate.com/kwaivgi/kling-v3-motion-control",
            "visibility": "public",
            "weights_url": None,
        }
    ...
    character_orientation: Character_orientation = Field(
...
class Seedance_2_0(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "bytedance/seedance-2.0:48110609e87e449f2d837660e4683a3b80e496b5d40d0823d1e0db4870835c82"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://replicate.delivery/xezq/3Uc0eKT36R2dIiXkrse8tD822Mhne8AIAMV6ekMcDg8WnWkZB/tmp7_ephsht.mp4",
            "created_at": "2026-04-05T18:54:24.788006Z",
    ...
    resolution: Resolution = Field(description="Video resolution.", default="720p")
    aspect_ratio: Aspect_ratio = Field(
