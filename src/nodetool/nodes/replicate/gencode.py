import asyncio
from nodetool.nodes.replicate.code_generation import (
...
replicate_nodes = [
    ...
    {
        "model_id": "ideogram-ai/ideogram-v2a",
        "node_name": "Ideogram_V2A",
        "namespace": "image.generate",
        "return_type": ImageRef,
        "overrides": {"image": ImageRef, "mask": ImageRef},
    },
    ...
    {
        "model_id": "wavespeedai/wan-2.1-i2v-480p",
        "node_name": "Wan_2_1_I2V_480p",
        "namespace": "video.generate",
        "return_type": VideoRef,
        "overrides": {"image": ImageRef},
    },
    {
        ...
        "node_name": "Wan_2_1_1_3B",
        "namespace": "video.generate",
        "return_type": VideoRef,
    },
    {
        "model_id": "anthropic/claude-3.7-sonnet",
        "node_name": "Claude_3_7_Sonnet",
        "namespace": "text.generate",
        "return_type": str,
    },
    {
    ...
    },
    {
        ...
        "node_name": "Deepseek_R1",
        "namespace": "text.generate",
        "return_type": str,
    },
    # === Added from Replicate Explore (Featured/Official/Popular) ===
    {
        "model_id": "pixverse/pixverse-v5",
        "node_name": "Pixverse_V5",
        "namespace": "video.generate",
        "return_type": VideoRef,
    },
    {
        "model_id": "google/nano-banana",
        "node_name": "Nano_Banana",
        "namespace": "image.process",
        "return_type": ImageRef,
        "overrides": {"image": ImageRef, "mask": ImageRef},
    },
    {
        ...
        "node_name": "Gen4_Turbo",
        "namespace": "video.generate",
        "return_type": VideoRef,
    },
    {
        "model_id": "runwayml/gen4-aleph",
        "node_name": "Gen4_Aleph",
        "namespace": "video.generate",
        "return_type": VideoRef,
    },
    {
        "model_id": "qwen/qwen-image",
        "node_name": "Qwen_Image",
        "namespace": "image.generate",
        "return_type": ImageRef,
        "overrides": {"image": ImageRef, "mask": ImageRef},
    },
    ...
    },
    {
        ...
        "node_name": "Kling_V2_1",
        "namespace": "video.generate",
        "return_type": VideoRef,
        "overrides": {"image": ImageRef},
    },
    {
        "model_id": "kwaivgi/kling-lip-sync",
        "node_name": "Kling_Lip_Sync",
        "namespace": "video.generate",
        "return_type": VideoRef,
        "overrides": {"audio": AudioRef, "video": VideoRef},
    },
    {
    ...
    {
        "model_id": "openai/gpt-5-structured",
        "node_name": "GPT_5_Structured",
        "namespace": "text.generate",
        "return_type": str,
    },
    {
    ...
    },
    {
        ...
        "node_name": "GPT_5_Mini",
        "namespace": "text.generate",
        "return_type": str,
    },
    {
        "model_id": "openai/gpt-5-nano",
        "node_name": "GPT_5_Nano",
        "namespace": "text.generate",
        "return_type": str,
    },
    {
    ...
    },
    {
        ...
        "node_name": "GPT_4_1_Mini",
        "namespace": "text.generate",
        "return_type": str,
    },
    {
        "model_id": "openai/gpt-4.1-nano",
        "node_name": "GPT_4_1_Nano",
        "namespace": "text.generate",
        "return_type": str,
    },
    {
        "model_id": "openai/gpt-4o-transcribe",
        "node_name": "GPT4o_Transcribe",
        "namespace": "audio.transcribe",
        "return_type": str,
        "overrides": {"audio": AudioRef},
    },
    {
        ...
        "node_name": "Imagen_4_Fast",
        "namespace": "image.generate",
        "return_type": ImageRef,
    },
    {
        "model_id": "ideogram-ai/ideogram-v3-turbo",
        "node_name": "Ideogram_V3_Turbo",
        "namespace": "image.generate",
        "return_type": ImageRef,
        "overrides": {"image": ImageRef, "mask": ImageRef},
    },
    ...
    },
    {
        ...
        "node_name": "Wan_2_2_T2V_Fast",
        "namespace": "video.generate",
        "return_type": VideoRef,
    },
    {
        "model_id": "wan-video/wan-2.2-i2v-fast",
        "node_name": "Wan_2_2_I2V_Fast",
        "namespace": "video.generate",
        "return_type": VideoRef,
        "overrides": {"image": ImageRef},
    },
    ...
    },
    {
        ...
        "node_name": "Lipsync_2_Pro",
        "namespace": "video.generate",
        "return_type": VideoRef,
        "overrides": {"audio": AudioRef, "video": VideoRef},
    },
    {
        "model_id": "bria/expand-image",
        "node_name": "Expand_Image",
        "namespace": "image.process",
        "return_type": ImageRef,
        "overrides": {"image": ImageRef},
    },
    ...
    {
        "model_id": "black-forest-labs/flux-2-klein-9b-base",
        "node_name": "Flux_2_Klein_9B_Base",
        "namespace": "image.generate",
        "return_type": ImageRef,
    },
    {
