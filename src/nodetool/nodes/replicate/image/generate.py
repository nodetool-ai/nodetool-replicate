...
class Flux_2_Klein_4B_Base(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "black-forest-labs/flux-2-klein-4b-base:2289efa5ebba21f5322ba1b73ac92bb6fec9f34bafc08e0c26f465dac6f8b465"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://replicate.delivery/xezq/Xo0RV43QWrZgLFh52q4ENesdYLp3DqezTR30IKIf8lgElW7rA/out.jpg",
            "created_at": "2026-01-15T11:23:38.854822Z",
            ...
            "paper_url": None,
            "run_count": 1122,
            "url": "https://replicate.com/black-forest-labs/flux-2-klein-4b-base",
            "visibility": "public",
            "weights_url": "https://huggingface.co/black-forest-labs/FLUX.2-klein-base-4B",
        }
