...
class Flux_Fill_Pro(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "black-forest-labs/flux-fill-pro:41c767bcbfffe54ef8f05eb4d0100f9314790f7fc43a7b88d73ec06839deddb9"
...
class Imagen_3(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "google/imagen-3:dd38058a6e74c700dcd05db62896386817f3af627bbe71f869f9a43f02773fd4"
...
class Qwen_Image(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "qwen/qwen-image:0bba9e70f78437359725e0989ead45ca8b09e6c12a070dfe9a09e6856b43a44d"
    ...
    extra_lora_scale: list | None = Field(
        title="Extra Lora Scale",
    ...
    extra_lora_weights: list | None = Field(
...
class Imagen_4_Fast(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "google/imagen-4-fast:efb61e33cffb69a1725083f675a44793929553f479918d01d6ce6e00efbee0d7"
...
class Flux_2_Pro(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "black-forest-labs/flux-2-pro:ccb5e33141097816e6fab8c895e702fe4c619e4e07500885b71214e9f6382a5c"
...
class Flux_2_Flex(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "black-forest-labs/flux-2-flex:51d0412f4874be5ad0fc559a9174a33b24927cb12729d4e3abf5a4f98ba1a4bc"
...
class GPT_Image_1_5(ReplicateNode):
    ...
    class Input_fidelity(str, Enum):
        LOW = "low"
        HIGH = "high"

    @classmethod
    def get_basic_fields(cls):
        return ["prompt", "quality", "user_id"]

    @classmethod
    def replicate_model_id(cls):
        return "openai/gpt-image-1.5:118f53498ea7319519229b2d5bd0d4a69e3d77eb60d6292d5db38125534dc1ca"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/06f56397-16a6-43f5-95a7-01e58cb6a5dd/gpt-image15-cover.jpg",
            "created_at": "2025-12-16T20:19:06.061796Z",
    ...
    quality: Quality = Field(
        description="The quality of the generated image", default="auto"
    )
...
class Flux_2_Max(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "black-forest-labs/flux-2-max:9c23b0aaa98765a9676dbdda58b9c9915627751300747bad54cb1c11b135d3ca"
...
class Nano_Banana_2(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "google/nano-banana-2:71516450bdbeafc41df33ad538bc8cc6a90f80038a563b1260531c02d694f4fd"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/80e7a89d-6163-4a92-927c-79ec74379079/nano-banana-2.png",
            "created_at": "2025-11-20T13:26:30.686291Z",
            ...
            "github_url": "https://github.com/replicate/cog-google-proxy",
            "license_url": None,
            "name": "nano-banana-2",
            "owner": "google",
            "is_official": True,
...
class Seedream_4_5(ReplicateNode):
    ...
    @classmethod
    def get_basic_fields(cls):
        return ["size", "prompt", "max_images"]

    @classmethod
    def replicate_model_id(cls):
        return "bytedance/seedream-4.5:e563f451edd459e76456dc2b32d7d2c02176059629759923965f9e86494325f6"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/2e35026c-1f46-4bbe-a314-e27079e943fa/seedream-45-sm.jpg",
            "created_at": "2025-12-03T04:08:05.221636Z",
    ...
    size: Size = Field(
        description="Image resolution: 2K (2048px) or 4K (4096px). Note: 1K resolution is not supported in Seedream 4.5.",
        default="2K",
    )
    prompt: str | None = Field(
        title="Prompt", description="Text prompt for image generation", default=None
    ...
    image_input: types.ImageRef = Field(
        default=types.ImageRef(),
...
class Seedream_5_Lite(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "bytedance/seedream-5-lite:eeb2857d94c49a5bcbc9d6c6057416e1d3b1a2735a16e08e4def9bf7ee22ec71"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/a21f19af-c659-4598-a0f7-093d32011814/replicate-prediction-nmj3175dt.png",
            "created_at": "2026-02-24T01:03:09.818374Z",
    ...
    size: Size = Field(
        description="Image resolution: 2K (2048px) or 3K (3072px).", default="2K"
    )
    prompt: str | None = Field(
        title="Prompt", description="Text prompt for image generation", default=None
    )
...
class Recraft_V4(ReplicateNode):
    ...
    @classmethod
    def get_basic_fields(cls):
        return ["size", "prompt", "aspect_ratio"]

    @classmethod
    def replicate_model_id(cls):
        return "recraft-ai/recraft-v4:a8bc7377c37baeea1e01568f88b6abfb38939135071a38ca4267c8f82c3cbbf0"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://replicate.delivery/xezq/3xGXF3IfTLW0I69qxg4Tz0xS7hU4uxQqOKxsMAnf8LrYD3IWA/tmpkjam_js3.webp",
            "created_at": "2026-02-17T10:41:11.411516Z",
            "description": "Recraft's latest image generation model, built around design taste. Strong prompt accuracy, art-directed composition, and integrated text rendering. Fast and cost-efficient at standard resolution.",
            "github_url": None,
            "license_url": "https://www.recraft.ai/terms",
            "name": "recraft-v4",
            "owner": "recraft-ai",
