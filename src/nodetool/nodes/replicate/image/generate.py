...
class GPT_Image_1(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "openai/gpt-image-1:5ac56c15446a60fa63b3823de926ada90f5971c2cf9b1dd07659126cfda434e6"
    ...
    openai_api_key: str | None = Field(
        title="Openai Api Key", description="Your OpenAI API key", default=None
    )
    number_of_images: int = Field(
        title="Number Of Images",
