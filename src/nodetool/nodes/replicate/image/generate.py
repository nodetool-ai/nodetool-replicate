...
class GPT_Image_1_5(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "openai/gpt-image-1.5:808df09e9b60ff3a6f4b27a9dac13569eddf0b4c552980346a2a3224c3cc2aca"
...
class Qwen_Image_Edit_2511(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "qwen/qwen-image-edit-2511:a0670a7f47d5975347c105b6ce71456c4377d511993975988127dee03ca6c729"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/c561eae9-8502-4a74-907b-e8b57cd7fc82/replicate-prediction-2krqph3q.webp",
            "created_at": "2025-12-22T14:22:42.213188Z",
            "description": "An enhanced version over Qwen-Image-Edit-2509, featuring multiple improvements including notably better consistency",
            "github_url": None,
            "license_url": None,
            ...
            "paper_url": None,
            "run_count": 188799,
            "url": "https://replicate.com/qwen/qwen-image-edit-2511",
            "visibility": "public",
            "weights_url": None,
        }
