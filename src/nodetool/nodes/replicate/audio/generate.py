...
class RealisticVoiceCloning(ReplicateNode):
    ...
    song_input: types.AudioRef = Field(
        default=types.AudioRef(), description="Upload your audio file here."
    )
...
class TortoiseTTS(ReplicateNode):
    ...
    custom_voice: types.AudioRef = Field(
...
class StyleTTS2(ReplicateNode):
    ...
    reference: types.AudioRef = Field(
        default=types.AudioRef(), description="Reference speech to copy style from"
    )
...
class Qwen3_TTS(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "qwen/qwen3-tts:0b366549c7541af95a69454651f4ebf02c699036841cd20b78b9e2a26b4b2750"
...
class Lyria_3_Pro(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "google/lyria-3-pro:555565680b0f9b0e52d9602505493eac6cb64eda682f7f85bd778646e22b8898"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/22671d81-7e89-4db5-bd35-0d2c514fd74e/Lyria-3-Pro_thumbnail.width-13.png",
            "created_at": "2026-04-02T14:10:03.506260Z",
            "description": "Generate full-length songs up to 3 minutes from text prompts or images with Lyria 3 Pro, Google's most capable music generation model",
            "github_url": None,
            "license_url": None,
            "name": "lyria-3-pro",
            "owner": "google",
...
class TTS_1_5_Mini(ReplicateNode):
