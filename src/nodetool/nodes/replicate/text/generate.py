...
class GPT_5_2(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "openai/gpt-5.2:e805d0794e42cc941a20b67ef7e57e432a7e4abdd36d61dbc6c842e911a75ec4"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_featured_image/a691f245-b594-4854-a8ce-8808f9bfdd5c/Screenshot_2025-12-11_at_1.27..png",
            "created_at": "2025-12-11T19:19:37.642398Z",
            ...
            "paper_url": None,
            "run_count": 173180,
            "url": "https://replicate.com/openai/gpt-5.2",
            "visibility": "public",
            "weights_url": None,
        }
    ...
    reasoning_effort: Reasoning_effort = Field(
        description="Constrains effort on reasoning for GPT-5.2 models. Supported values are none, low, medium, high, and xhigh.",
        default="low",
    )
    max_completion_tokens: int | None = Field(
        title="Max Completion Tokens",
