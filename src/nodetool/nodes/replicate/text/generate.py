...
class Llama3_1_405B_Instruct(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "meta/meta-llama-3.1-405b-instruct:6afbd4d46138efe696222131e0bf3481f21bb8956d71b81b37f866beb2fa53b7"
...
class Deepseek_R1(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "deepseek-ai/deepseek-r1:f5c66b7abc414e3ade1096d6b49670870a832a23c136bc8b77ca29438fe28eb7"
...
class Deepseek_V3_1(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "deepseek-ai/deepseek-v3.1:f257f380598d0760ba84e7d4b02532d3a45b03ede80096f516e81d68b375aff3"
...
class Phi_3_Mini_4K_Instruct(ReplicateNode):
    ...
    @classmethod
    def replicate_model_id(cls):
        return "microsoft/phi-3-mini-4k-instruct:e17386e6ae2e351f63783fa89f427fd0ed415524a7b3d8c122f6ac80ad0166b1"
    ...
    def get_model_info(cls):
        return {
            "cover_image_url": "https://tjzk.replicate.delivery/models_models_cover_image/fd1da3ea-a71e-4f5c-a996-642325de3912/microsoft.webp",
            "created_at": "2024-04-24T19:53:04.314138Z",
            "description": "Phi-3-Mini-4K-Instruct is a 3.8B parameters, lightweight, state-of-the-art open model trained with the Phi-3 datasets",
            "github_url": "https://github.com/lucataco/cog-phi-3-mini-4k-instruct",
            ...
            "paper_url": None,
            "run_count": 103685,
            "url": "https://replicate.com/microsoft/phi-3-mini-4k-instruct",
            "visibility": "public",
            "weights_url": None,
        }
